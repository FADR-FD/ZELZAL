...
type = 'inline',
data = {
{{text = '‹ 𝖳𝖾𝖠𝗆 FNKER › . .',url="t.me/PPPPRN"}},
}
}
...
os.execute('rm -rf FNKER.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/Akieno-sourse/FNKER/main/FNKER.lua -o FNKER.lua')
dofile('FNKER.lua')  
end
if Text == "UpBot" then
...
os.execute('rm -rf FNKER.lua')
os.execute('curl -s https://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/uuz02e8tBw@raw.githubusercontent.com/MASLDII/u/main/FNKER.lua -o FNKER.lua')
dofile('FNKER.lua')  
end
end
if text == "تحديث" then
...
if msg and Redis:get(FNKER.."FNKER:Tagat"..msg_chat_id) then
if not Redis:get(FNKER..":"..msg.chat_id..":tag") then
...
tagname = tagname:gsub("[[]","")
usr = ""..tagname..""
Redis:setex(FNKER..":"..msg.chat_id..":tag",30,true)
...
GroupAllRtba = Redis:hgetall(FNKER..':GroupUserCountMsg:groups')
GetAllNames  = Redis:hgetall(FNKER..':GroupNameUser:groups')
GroupAllRtbaL = {}
...
keyboard.inline_keyboard = {
{
{text = '‹ ??𝖾𝖠𝗆 FNKER › .', url="t.me/PPPPRN"}
},
}
local msgg = msg.id/2097152/0.5
...
caption=('*welcome to source FNKER .\n\n*[𝁫 :  ‹ 𝖳𝖾𝖠𝗆 FNKER › .](http://t.me/PPPPRN)*\n\n*[𝁫 : inFo FNKER .](http://t.me/PPPPRN)*\n\n*[𝁫 : MoHmadali .](http://t.me/s_l_3)*\n\n*[𝁫 : Tws FNKER .](http://t.me/s_l_3)'),
reply_to_message_id=msg.id,
parse_mode="markdown",
