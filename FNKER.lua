...
os.execute('chmod +x FNKER;chmod +x Run;./Run')
end
...
FNKER = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..FNKER)
LuaTele = luatele.set_config{api_id=1846213,api_hash='c545c613b78f18a30744970910124d53',session_name=FNKER,token=Token}
function var(value)
...
shh = tostring(text)
if Redis:get(FNKER..'rmzsource') then
shh = shh:gsub("※",Redis:get(FNKER..'rmzsource'))
end
local listm = Redis:smembers(FNKER.."Words:r")
for k,v in pairs(listm) do
i ,j  = string.find(shh, v)
if j and i then
local x = string.sub(shh, i,j)
local neww = Redis:get(FNKER.."Word:Replace"..x)  
shh = shh:gsub(x,neww)
else
shh = shh
end
...
sh = tostring(text)
if Redis:get(FNKER..'rmzsource') then
sh = sh:gsub("※",Redis:get(FNKER..'rmzsource'))
end
local listm = Redis:smembers(FNKER.."Words:r")
for k,v in pairs(listm) do
...
if Redis:sismember(FNKER.."BanGroup:Group"..chat,useri) then
BanGroupz = "✔"
else
BanGroupz = "❌"
end
if Redis:sismember(FNKER.."SilentGroup:Group"..chat,useri) then
SilentGroupz = "✔"
else
SilentGroupz = "❌"
end
if Redis:sismember(FNKER.."SuperCreator:Group"..chat,useri)  then
SuperCreatorz = "✔"
else
SuperCreatorz = "❌"
end
if Redis:sismember(FNKER.."Creator:Group"..chat,useri) then
Creatorz = "✔"
else
Creatorz = "❌"
end
if Redis:sismember(FNKER.."Manger:Group"..chat,useri) then
Mangerz = "✔"
else
Mangerz = "❌"
end
if Redis:sismember(FNKER.."Admin:Group"..chat,useri) then
Adminz = "✔"
else
Adminz = "❌"
end
if Redis:sismember(FNKER.."Special:Group"..chat,useri) then
Specialz = "✔"
else
Specialz = "❌"
end
...
if Redis:get(FNKER..'chsource') then
chsource = Redis:get(FNKER..'chsource')
else
chsource = "QQQiiQ"
end
if Redis:get(FNKER..'chdevolper') then
chdevolper = Redis:get(FNKER..'chdevolper')
else 
chdevolper = "JJJ_JJJ"
end
...
Status = 0
Devss = Redis:sismember(FNKER.."Devss:Groups",UserId) 
Dev = Redis:sismember(FNKER.."Dev:Groups",UserId)
Supcreator = Redis:sismember(FNKER.."Supcreator:Group"..ChatId,UserId) 
Owners = Redis:sismember(FNKER.."Owners:Group"..ChatId,UserId) 
Creator = Redis:sismember(FNKER.."Creator:Group"..ChatId,UserId)
Manger = Redis:sismember(FNKER.."Manger:Group"..ChatId,UserId)
Admin = Redis:sismember(FNKER.."Admin:Group"..ChatId,UserId)
Special = Redis:sismember(FNKER.."Special:Group"..ChatId,UserId)
...
elseif UserId == FNKER then
Status = 'البوت'
elseif Devss then
Status = Redis:get(FNKER.."Devss:Groups"..ChatId) or 'المطور الثانوي'
elseif Dev then
Status = Redis:get(FNKER.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif Owners then
Status = Redis:get(FNKER.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif Supcreator then
Status = Redis:get(FNKER.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Creator then
Status = Redis:get(FNKER.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Manger then
Status = Redis:get(FNKER.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Admin then
Status = Redis:get(FNKER.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعة'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعة'
elseif Special then
Status = Redis:get(FNKER.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(FNKER.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(FNKER.."lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(FNKER.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(FNKER.."Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(FNKER.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(FNKER.."Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(FNKER.."Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(FNKER.."Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(FNKER.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(FNKER.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقييد "     
elseif Redis:hget(FNKER.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(FNKER.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(FNKER.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(FNKER.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقييد "   
elseif Redis:get(FNKER.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(FNKER.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(FNKER.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(FNKER.."Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(FNKER.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(FNKER.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(FNKER.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(FNKER.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(FNKER.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(FNKER.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(FNKER.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(FNKER.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(FNKER.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(FNKER.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(FNKER.."Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(FNKER.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(FNKER.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(FNKER.."Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(FNKER.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(FNKER.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(FNKER.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(FNKER.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(FNKER.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(FNKER.."Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(FNKER.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(FNKER.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(FNKER.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(FNKER.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقييد "
elseif Redis:get(FNKER.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(FNKER.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(FNKER.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(FNKER.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(FNKER.."Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(FNKER.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(FNKER.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(FNKER.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(FNKER.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(FNKER.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقييد "   
elseif Redis:get(FNKER.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(FNKER.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(FNKER.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(FNKER.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(FNKER.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقييد "    
elseif Redis:get(FNKER.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(FNKER.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(FNKER.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(FNKER.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(FNKER.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(FNKER.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,FNKER).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(FNKER.."chfalse")
if chh then
...
--
--
if tonumber(msg.sender.user_id) == tonumber(FNKER) then
print('This is reply for Bot')
return false
end
if data.sender.luatele == "messageSenderChat" then
if Redis:get(FNKER.."Lock:channell"..msg_chat_id) then
local m = Redis:get(FNKER.."chadmin"..msg_chat_id) 
...
Redis:incr(FNKER..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
elseif Redis:sismember(FNKER.."Devss:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(FNKER.."Dev:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(FNKER.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(FNKER.."Owners:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(FNKER.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(FNKER.."Supcreator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(FNKER.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(FNKER.."Creator:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(FNKER.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(FNKER.."Manger:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(FNKER.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(FNKER.."Admin:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(FNKER.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(FNKER.."Special:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(FNKER.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(FNKER) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(FNKER.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(FNKER.."Lock:text"..msg_chat_id) and not msg.Special then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" or msg.content.luatele == "messageChatAddMembers" then
if Redis:get(FNKER.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(FNKER.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Special and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(FNKER.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(FNKER) then
return false
end
local floods = Redis:hget(FNKER.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(FNKER.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(FNKER.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(FNKER.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(FNKER.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
Redis:setex(FNKER.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(FNKER.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(FNKER.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
if text and Redis:get(FNKER..'lock:Fshar'..msg.chat_id) and not msg.Special then 
...
if text and Redis:get(FNKER..'lock:Fars'..msg.chat_id) and not msg.Special then 
...
sens = 400  
if Redis:get(FNKER.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(FNKER.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(FNKER.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(FNKER.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(FNKER.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Admin then -- التوجيه
local Fwd_Group = Redis:get(FNKER.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(FNKER.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(FNKER.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(FNKER.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(FNKER.."lockpin"..msg_chat_id)
...
Redis:incr(FNKER.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(FNKER.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(FNKER.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(FNKER) then
local N = (Redis:get(FNKER.."Name:Bot") or "مالوركا")
photo = LuaTele.getUserProfilePhotos(FNKER)
...
{
{text = 'Source FNKER', url = 't.me/QQQiiQ'},
}
}
...
Redis:set(FNKER.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(FNKER.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(FNKER.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(FNKER.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(FNKER.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(FNKER.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(FNKER.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(FNKER.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(FNKER.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(FNKER.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(FNKER.."Lock:Animation"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Special then 
local comd_Group = Redis:get(FNKER.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(FNKER..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(FNKER.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(FNKER.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(FNKER.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(FNKER.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(FNKER.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(FNKER.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(FNKER.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(FNKER.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(FNKER..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return send(msg_chat_id,msg_id,"\n˖ ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(FNKER..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(FNKER.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(FNKER.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(FNKER.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(FNKER..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return send(msg_chat_id,msg_id,"\n˖ تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(FNKER..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(FNKER.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(FNKER.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(FNKER.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(FNKER.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(FNKER.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(FNKER.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(FNKER.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(FNKER.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(FNKER..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(FNKER.."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters and not msg.Dev then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return send(msg_chat_id,msg_id,"*˖ لقد تم منع هذه ( "..statusfilter.." ) هنا*\n˖"..ReplyFilters,"md",true)   
end
end
if text and Redis:get(FNKER..msg.chat_id..msg.sender.user_id.."replace") == "true1" then
Redis:del(FNKER..msg.chat_id..msg.sender.user_id.."replace")
local word = Redis:get(FNKER..msg.sender.user_id.."word")
Redis:set(FNKER.."Word:Replace"..word,text)
Redis:sadd(FNKER..'Words:r',word)  
LuaTele.sendText(msg_chat_id,msg_id,"˖ تم حفظ الكلمه","md",true)  
return false 
end
if text and Redis:get(FNKER..msg.chat_id..msg.sender.user_id.."replace") == "true" then
Redis:set(FNKER..msg.sender.user_id.."word",text)
Redis:set(FNKER..msg.chat_id..msg.sender.user_id.."replace","true1")
LuaTele.sendText(msg_chat_id,msg_id,'\n˖ ارسل كلمه جديده ليتم استبدالها مكان *'..text..'*',"md",true)  
return false 
end
if text and Redis:get(FNKER.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(FNKER.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(FNKER.."All:Get:Reides:Commands:Group"..text)
Redis:del(FNKER.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(FNKER.."All:Command:List:Group",text)
send(msg_chat_id,msg_id,"˖ تم ازالة هاذا » { "..text.." }","md",true)
else
send(msg_chat_id,msg_id,"˖ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(FNKER.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(FNKER.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(FNKER.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(FNKER.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(FNKER.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return send(msg_chat_id,msg_id,"˖ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(FNKER.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(FNKER.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(FNKER.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(FNKER.."All:Command:List:Group",text)
Redis:del(FNKER.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
if Redis:get(FNKER.."lockalllll"..msg_chat_id) == "off" then
...
if text and Redis:get(FNKER.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(FNKER.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(FNKER.."Command:List:Group"..msg_chat_id,text)
send(msg_chat_id,msg_id,"˖ تم ازالة هاذا » { "..text.." }","md",true)
else
send(msg_chat_id,msg_id,"˖ لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(FNKER.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(FNKER.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(FNKER.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(FNKER.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(FNKER.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return send(msg_chat_id,msg_id,"˖ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(FNKER.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(FNKER.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(FNKER.."Command:List:Group"..msg_chat_id,text)
Redis:del(FNKER.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return send(msg_chat_id,msg_id,"˖ تم حفظ الامر باسم » { "..text..' }',"md",true)
end
if Redis:get(FNKER.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(FNKER.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return send(msg_chat_id,msg_id,"٭ تم الغاء حفظ الرابط","md",true)         
end
Redis:set(FNKER.."Group:Link"..msg_chat_id,text)
Redis:del(FNKER.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return send(msg_chat_id,msg_id,"٭ تم حفظ الرابط بنجاح","md",true)         
end 
if Redis:get(FNKER.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(FNKER.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return send(msg_chat_id,msg_id,"˖ تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(FNKER.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(FNKER.."Welcome:Group"..msg_chat_id,text) 
return send(msg_chat_id,msg_id,"˖ تم حفظ ترحيب المجموعة","md",true)     
end
if Redis:get(FNKER.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(FNKER.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return send(msg_chat_id,msg_id,"˖ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(FNKER.."Group:Rules" .. msg_chat_id,text) 
Redis:del(FNKER.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return send(msg_chat_id,msg_id,"˖ تم حفظ قوانين المجموعة","md",true)  
end  
if Redis:get(FNKER.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(FNKER.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(FNKER.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(FNKER.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(FNKER.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FNKER.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(FNKER.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(FNKER.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(FNKER.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(FNKER.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(FNKER.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(FNKER.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(FNKER.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(FNKER.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(FNKER.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
...
Redis:set(FNKER.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(FNKER.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(FNKER.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(FNKER.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(FNKER.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(FNKER.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(FNKER.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(FNKER.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(FNKER.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(FNKER.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(FNKER.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(FNKER.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(FNKER.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(FNKER.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(FNKER.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(FNKER.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(FNKER.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(FNKER.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(FNKER.."List:Manager"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,"˖ تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= FNKER then
local test = Redis:get(FNKER.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(FNKER.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(FNKER.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FNKER.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(FNKER.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(FNKER.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(FNKER.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(FNKER.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(FNKER.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(FNKER.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(FNKER.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(FNKER.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(FNKER.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(FNKER.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(FNKER.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(FNKER.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(FNKER.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(FNKER.."List:Rd:Sudo", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(FNKER..''..v..text)
end
Redis:del(FNKER.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(FNKER.."List:Rd:Sudo", text)
return send(msg_chat_id,msg_id,"˖ تم حذف الرد من الردود العامه","md",true)  
end
end
if text and not Redis:get(FNKER.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(FNKER..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(FNKER.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(FNKER.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(FNKER.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(FNKER.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(FNKER.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(FNKER.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(FNKER.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(FNKER.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(FNKER.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(FNKER.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(FNKER.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(FNKER.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(FNKER..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(FNKER..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(FNKER.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text and not Redis:get(FNKER.."Status:Reply"..msg_chat_id) then
local anemi = Redis:get(FNKER.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(FNKER.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(FNKER.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(FNKER.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(FNKER.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(FNKER.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(FNKER.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(FNKER.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(FNKER.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(FNKER.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(FNKER.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(FNKER.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(FNKER..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if Redis:get(FNKER..'Set:array'..msg.sender.user_id..':'..msg_chat_id) == 'true1' then
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
local test = Redis:get(FNKER..'Text:array'..msg.sender.user_id..':'..msg_chat_id..'')
Redis:sadd(FNKER.."Add:Rd:array:Text"..test,text)  
_key = {
...
if text then
if Redis:get(FNKER.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'dttd' then
Redis:del(FNKER.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
gery = Redis:get(FNKER.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(FNKER.."Add:Rd:array:Text"..gery,text) then
send(msg_chat_id, msg_id,' * ˖ لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:srem(FNKER.."Add:Rd:array:Text"..gery,text)
send(msg_chat_id, msg_id,' * ˖ تم حذفه بنجاح .* ',"md",true)
end
end
if text then
if Redis:get(FNKER.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(FNKER.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id)
if not Redis:sismember(FNKER..'List:array',text) then
send(msg_chat_id, msg_id,' * ˖ لا يوجد رد متعدد * ',"md",true)
return false
end
Redis:set(FNKER.."Set:array:addpu"..msg.sender.user_id..":"..msg_chat_id,text)
Redis:set(FNKER.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"dttd")
...
Redis:set(FNKER.."Set:array:Ssd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end
if text then
if Redis:get(FNKER.."Set:array"..msg.sender.user_id..":"..msg_chat_id) == 'true' then
Redis:sadd(FNKER..'List:array', text)
Redis:set(FNKER..'Text:array'..msg.sender.user_id..':'..msg_chat_id, text)
send(msg_chat_id, msg_id,'ارسل الرد الذي تريد اضافته',"md",true)
Redis:del(FNKER.."Set:array"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(FNKER..'Set:array'..msg.sender.user_id..':'..msg_chat_id,'true1')
Redis:del(FNKER.."Add:Rd:array:Text"..text)   
return false
end
end

if text then
if Redis:get(FNKER.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id) == 'delrd' then
Redis:del(FNKER.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:del(FNKER.."Add:Rd:array:Text"..text)
Redis:srem(FNKER..'List:array', text)
...
if Redis:get(FNKER.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ˖' then   
Redis:del(FNKER.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n˖ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(FNKER.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(FNKER.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(FNKER.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(FNKER.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(FNKER.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(FNKER.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(FNKER.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(FNKER.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(FNKER.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
send(v,0,text,"html",true)
Redis:set(FNKER.."PinMsegees:"..v,text)
end
end
...
if Redis:get(FNKER.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ˖' then   
Redis:del(FNKER.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n˖ تم الغاء الاذاعه بالتوجيه للخاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(FNKER.."Num:User:Pv") 
...
if Redis:get(FNKER.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ˖' then   
Redis:del(FNKER.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(FNKER.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ˖' then   
Redis:del(FNKER.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n˖ تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(FNKER.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(FNKER.."chmembers") == "on" then
if ChannelJoin(msg) == false then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local n = UserInfo.first_name
local d = UserInfo.id
local chinfo = Redis:get(FNKER.."ch:admin")
...
if Redis:get(FNKER.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ˖' then   
Redis:del(FNKER.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(FNKER..'GetTexting:DevFNKER'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ˖' then 
Redis:del(FNKER..'GetTexting:DevFNKER'..msg_chat_id..':'..msg.sender.user_id)
return send(msg_chat_id,msg_id,'˖ تم الغاء حفظ كليشة المطور')
end
Redis:set(FNKER..'Texting:DevFNKER',text)
Redis:del(FNKER..'GetTexting:DevFNKER'..msg_chat_id..':'..msg.sender.user_id)
return send(msg_chat_id,msg_id,'˖ تم حفظ كليشة المطور')
end
if Redis:get(FNKER.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
send(msg_chat_id,msg_id, "\n˖ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(FNKER.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(FNKER.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(FNKER.."Set:Id:Groups",text:match("(.*)"))
send(msg_chat_id,msg_id,'˖ تم تعين الايدي عام',"md",true)  
end
if Redis:get(FNKER.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
send(msg_chat_id,msg_id, "\n˖ تم الغاء امر تعين الايدي","md",true)  
Redis:del(FNKER.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(FNKER.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(FNKER.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
send(msg_chat_id,msg_id,'˖ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(FNKER.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ˖' then   
Redis:del(FNKER.."Change:Name:Bot"..msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n˖ تم الغاء امر تغيير اسم البوت","md",true)  
end 
Redis:del(FNKER.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(FNKER.."Name:Bot",text) 
return send(msg_chat_id,msg_id, "˖ تم تغيير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(FNKER.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ˖' then   
Redis:del(FNKER.."Change:Start:Bot"..msg.sender.user_id) 
return send(msg_chat_id,msg_id, "\n˖ تم الغاء امر تغيير كليشه start","md",true)  
end 
Redis:del(FNKER.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(FNKER.."Start:Bot",text) 
return send(msg_chat_id,msg_id, "˖ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(FNKER.."Game:Smile"..msg.chat_id) then
if text == Redis:get(FNKER.."Game:Smile"..msg.chat_id) then
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FNKER.."Game:Smile"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n˖ لقد فزت في اللعبه \n˖ العب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(FNKER.."mshaher"..msg.chat_id) then
if text == Redis:get(FNKER.."mshaher"..msg.chat_id) then
Redis:del(FNKER.."mshaher"..msg.chat_id)
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n˖ لقد فزت في اللعبه \n˖ العب مره اخره وارسل - بوب او مشاهير","md",true)  
end
end 
if Redis:get(FNKER.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(FNKER.."Game:Monotonous"..msg.chat_id) then
Redis:del(FNKER.."Game:Monotonous"..msg.chat_id)
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n˖ لقد فزت في اللعبه \n˖ العب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(FNKER.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(FNKER.."Game:Riddles"..msg.chat_id) then
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FNKER.."Game:Riddles"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n˖ لقد فزت في اللعبه \n˖ العب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(FNKER.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(FNKER.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FNKER.."Game:Meaningof"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n˖ لقد فزت في اللعبه \n˖ العب مره اخره وارسل - معاني","md",true)  
end
end
if Redis:get(FNKER.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(FNKER.."Game:enkliz"..msg.chat_id) then
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FNKER.."Game:enkliz"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n˖ لقد فزت في اللعبه \n˖ العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(FNKER.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(FNKER.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FNKER.."Game:Countrygof"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n˖ لقد فزت في اللعبه \n˖ العب مره اخره وارسل - اعلام","md",true)  
end
end
if Redis:get(FNKER.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(FNKER.."Game:Reflection"..msg.chat_id) then
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(FNKER.."Game:Reflection"..msg.chat_id)
return send(msg_chat_id,msg_id,"\n˖ لقد فزت في اللعبه \n˖ العب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(FNKER.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return send(msg_chat_id,msg_id,"˖ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(FNKER.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(FNKER.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(FNKER.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return send(msg_chat_id,msg_id,"˖ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(FNKER.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(FNKER.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(FNKER.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(FNKER.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(FNKER.."Game:Difference"..msg.chat_id) then
if text == Redis:get(FNKER.."Game:Difference"..msg.chat_id) then 
Redis:del(FNKER.."Game:Difference"..msg.chat_id)
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n˖ لقد فزت في اللعبه \n˖ العب مره اخره وارسل - المختلف","md",true)  
end
end
if Redis:get(FNKER.."Game:Example"..msg.chat_id) then
if text == Redis:get(FNKER.."Game:Example"..msg.chat_id) then 
Redis:del(FNKER.."Game:Example"..msg.chat_id)
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return send(msg_chat_id,msg_id,"\n˖ لقد فزت في اللعبه \n˖ العب مره اخره وارسل - امثله","md",true)  
end
end
if text then
local NewCmmd = Redis:get(FNKER.."All:Get:Reides:Commands:Group"..text) or Redis:get(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
text = (NewCmmd or text)
end
end
if Redis:get(FNKER.."ch:addd"..msg.sender.user_id) == "on" then
Redis:set(FNKER.."ch:addd"..msg.sender.user_id,"off")
...
Redis:del(FNKER.."chfalse")
Redis:set(FNKER.."chfalse",ch)
Redis:del(FNKER.."ch:admin")
Redis:set(FNKER.."ch:admin",data.result.invite_link)
else
...
Redis:set(FNKER.."ch:addd"..msg.sender.user_id,"on")
...
if tonumber(FNKER) ~= tonumber(FilesJson.BotId) then
return send(msg_chat_id,msg_id,'˖ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(FNKER..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(FNKER.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(FNKER.."Supcreator:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(FNKER.."Creator:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(FNKER.."Manger:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(FNKER.."Admin:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(FNKER.."Special:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(FNKER) then 
return send(msg_chat_id,msg_id,'˖ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(FNKER.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(FNKER.."Creator:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(FNKER.."Manger:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(FNKER.."Admin:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(FNKER.."Supcreator:Group"..idg,idASAS)
end;end
end
...
Redis:set(FNKER.."SendBcBot",true) 
...
Redis:set(FNKER.."LeftBot",true) 
return send(msg_chat_id,msg_id,"˖ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(FNKER.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر ˖' then   
Redis:del(FNKER.."AddSudosNew"..msg_chat_id)
...
Redis:set(FNKER.."AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(FNKER..'ChekBotAdd')  
local UsersBot = Redis:smembers(FNKER..'Num:User:Pv')  
local Get_Json = '{"BotId": '..FNKER..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(FNKER.."Supcreator:Group"..v)
local Constructor = Redis:smembers(FNKER.."Creator:Group"..v)
local Manager = Redis:smembers(FNKER.."Manger:Group"..v)
local Admin = Redis:smembers(FNKER.."Admin:Group"..v)
local Vips = Redis:smembers(FNKER.."Special:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(FNKER..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
send(msg_chat_id,msg_id,'*˖عدد احصائيات البوت الكامله \nــــــــــــــــــــــــ\n˖عدد المجموعات : '..(Redis:scard(FNKER..'ChekBotAdd') or 0)..'\n˖عدد المشتركين : '..(Redis:scard(FNKER..'Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'تفعيل' and msg.Dev then
if Redis:sismember(FNKER..'ban:online',msg.chat_id) then
...
if Redis:sismember(FNKER.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(FNKER..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return send(msg_chat_id,msg_id,'˖عدد الاعضاء قليل لا يمكن تفعيل المجموعة  يجب ان يكوم اكثر من :'..Redis:get(FNKER..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(FNKER.."ChekBotAdd",msg_chat_id)
Redis:set(FNKER.."Status:Id"..msg_chat_id,true) ;Redis:del(FNKER.."Status:Reply"..msg_chat_id) ;Redis:del(FNKER.."Status:ReplySudo"..msg_chat_id) ;Redis:set(FNKER.."Status:BanId"..msg_chat_id,true) ;Redis:set(FNKER.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(FNKER.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(FNKER.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(FNKER.."ChekBotAdd",msg_chat_id)
return send(msg_chat_id,msg_id,'\n*˖المجموعة : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n˖ تم تعطيلها بنجاح *','md',true)
end
end
if chat_type(msg.chat_id) == "GroupBot" and not Redis:sismember(FNKER.."ChekBotAdd",msg_chat_id) then
if Redis:sismember(FNKER..'ban:online',msg.chat_id) then
LuaTele.leaveChat(msg.chat_id)
return false 
end
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(FNKER.."ChekBotAdd",msg_chat_id) then
if text then
local GetMsg = Redis:incr(FNKER..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
Redis:hset(FNKER..':GroupUserCountMsg:'..msg.chat_id,msg.sender.user_id,GetMsg)
local UserInfo = LuaTele.getUser(msg.sender.user_id) 
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(FNKER..':GroupNameUser:'..msg.chat_id,msg.sender.user_id,NameLUser)
end
...
if Redis:get(FNKER.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'start' then
Redis:set(FNKER.."audio:Games"..msg.sender.user_id..":"..msg.chat_id,msg.content.audio.audio.remote.id)  
Redis:sadd(FNKER.."audio:Games:Bot",msg.content.audio.audio.remote.id)  
Redis:set(FNKER.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id,'started')
return send(msg.chat_id, msg.id,'• ارسل اسم الموسيقى الان ...')
end   
end

if Redis:get(FNKER.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id) == 'started' then
Redis:del(FNKER.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id)
local Id_audio = Redis:get(FNKER.."audio:Games"..msg.sender.user_id..":"..msg.chat_id)
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)  
Redis:del(FNKER..'Text:Games:audio'..Message_Reply.content.audio.audio.remote.id)  
Redis:srem(FNKER.."audio:Games:Bot",Message_Reply.content.audio.audio.remote.id)  
...
Redis:set(FNKER.."Add:audio:Games"..msg.sender.user_id..":"..msg.chat_id,'start')
...
local list = Redis:smembers(FNKER.."audio:Games:Bot")
if #list == 0 then
...
for k,v in pairs(list) do
Redis:del(FNKER..'Text:Games:audio'..v)  
Redis:srem(FNKER.."audio:Games:Bot",v)  
end
...
local GetAnswer = Redis:get(FNKER..'Text:Games:audio'..quschen)
Redis:set(FNKER..'Games:Set:Answer'..msg.chat_id,GetAnswer)
...
local TotalMsg = Redis:get(FNKER..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(FNKER..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(FNKER.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(FNKER.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
...
if msg.reply_to_message_id == 0 then
if not Redis:get(FNKER.."Status:Id"..msg_chat_id) then
return false
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(FNKER.."ch:admin")
...
local TotalMsg = Redis:get(FNKER..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(FNKER..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(FNKER.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {
  "˖ ˖",
}
...
Get_Is_Id = Redis:get(FNKER.."Set:Id:Groups") or Redis:get(FNKER.."Set:Id:Group"..msg_chat_id)
if Redis:get(FNKER.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,FNKER).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return send(msg_chat_id,msg_id,'˖ البوت عضو في المجموعة ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,FNKER).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(FNKER.."Devss:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Devss:Groups",UserId_Info.id) 
...
if not Redis:sismember(FNKER.."Dev:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Dev:Groups",UserId_Info.id) 
...
if not Redis:sismember(FNKER.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(FNKER.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(FNKER.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(FNKER.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(FNKER.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(FNKER.."Special:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(FNKER.."Devss:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Devss:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."Dev:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Dev:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم تنزيله من الوتكات قبل كدة 🙃 ").Reply,"md",true)  
else
Redis:srem(FNKER.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖اتعالج خلاص 🙃 ").Reply,"md",true)  
else
Redis:srem(FNKER.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "كلب" then
if not Redis:sismember(FNKER.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖الكلب دا بطل هوهوه ونزلناه  🙃 ").Reply,"md",true)  
else
Redis:srem(FNKER.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖الحمار دا عقل من زمان   🙃 ").Reply,"md",true)  
else
Redis:srem(FNKER.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "سمب" then
if not Redis:sismember(FNKER.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖بطل يمشي ورا الحريم 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(FNKER.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(FNKER.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖بطل يطنط علي شجر 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(FNKER.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "عره" then
if not Redis:sismember(FNKER.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(FNKER.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "غبي" then
if not Redis:sismember(FNKER.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(FNKER.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."Dev:Groups",UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"˖ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Dev:Groups",UserId) 
...
if not Redis:sismember(FNKER.."Owners:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(FNKER.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(FNKER.."Creator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(FNKER.."Manger:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(FNKER.."Admin:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(FNKER.."Special:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."Special:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(FNKER.."Devss:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Devss:Groups",UserId_Info.id) 
...
if Redis:sismember(FNKER.."Dev:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Dev:Groups",UserId_Info.id) 
...
if Redis:sismember(FNKER.."Owners:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Owners:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(FNKER.."Supcreator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Supcreator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(FNKER.."Creator:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Creator:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(FNKER.."Manger:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Manger:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Creator and not Redis:get(FNKER.."Status:SetId"..msg_chat_id) then
return send(msg_chat_id,msg_id,"˖ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(FNKER.."Admin:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Admin:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(FNKER.."Special:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Special:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(FNKER.."Devss:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Devss:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."Dev:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Dev:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Owners:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Supcreator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Creator:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Manger:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Admin:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Special:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖محطوط ف قايمة الخولات من  بدري 😂 ").Reply,"md",true)  
else
Redis:sadd(FNKER.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(FNKER.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖دا مولود كده ومحطوط عندنا من زمان 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(FNKER.."twhd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(FNKER.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖نزلناه من زمان وفكينا الكارو 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(FNKER.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖نزلناه من زمان واخد كورسات رجوله 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(FNKER.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖نزلناه من زمان من ع الشجره 😂 😂 ").Reply,"md",true)  
else
Redis:sadd(FNKER.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖محدش محترمه كده كده  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(FNKER.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖هو كده كده محطوط ف قايمة الاغبية  😂 😂 ").Reply,"md",true)  
else
Redis:sadd(FNKER.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."Owners:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Owners:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(FNKER.."Supcreator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Supcreator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(FNKER.."Creator:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Creator:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(FNKER.."Manger:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Manger:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(FNKER.."Admin:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Admin:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(FNKER.."Special:Group"..msg_chat_id,UserId[2]) then
return send(msg_chat_id,msg_id,Reply_Status(UserId[2],"˖ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."Special:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(FNKER.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(FNKER.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(FNKER.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(FNKER.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(FNKER.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(FNKER.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(FNKER.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(FNKER.."Devss:Groups") 
...
local Info_Members = Redis:smembers(FNKER.."Dev:Groups") 
if #Info_Members == 0 then
return send(msg_chat_id,msg_id,"˖ لا يوجد مطورين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(FNKER.."Owners:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."Supcreator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."Creator:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."Manger:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."Admin:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."Special:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."twhd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(FNKER.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(FNKER.."Status:Link"..msg_chat_id,true) 
return send(msg_chat_id,msg_id,"˖ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(FNKER.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(FNKER.."Status:Id"..msg_chat_id,true) 
...
Redis:set(FNKER.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:del(FNKER.."Status:Reply"..msg_chat_id) 
...
Redis:del(FNKER.."Status:ReplySudo"..msg_chat_id) 
...
Redis:set(FNKER.."Status:BanId"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(FNKER.."Status:Link"..msg_chat_id) 
return send(msg_chat_id,msg_id,"˖ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(FNKER.."Status:Welcome"..msg_chat_id) 
...
Redis:del(FNKER.."Status:Id"..msg_chat_id) 
...
Redis:del(FNKER.."Status:IdPhoto"..msg_chat_id) 
...
Redis:set(FNKER.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(FNKER.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:del(FNKER.."Status:BanId"..msg_chat_id) 
...
if Redis:sismember(FNKER.."BanAll:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(FNKER.."ktmAll:Groups",UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."ktmAll:Groups",UserId_Info.id) 
...
if not msg.Creator and not Redis:get(FNKER.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(FNKER.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(FNKER.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم الغاء حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(FNKER.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم كتمه في المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(FNKER.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(FNKER.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return send(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"˖ تم الغاء كتمه من المجموعة ").Reply,"md",true)  
end
end
...
if Redis:sismember(FNKER.."BanAll:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(FNKER.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."ktmAll:Groups",Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(FNKER.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(FNKER.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(FNKER.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم الغاء حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(FNKER.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم كتمه في المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(FNKER.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(FNKER.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return send(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"˖ تم الغاء كتمه من المجموعة ").Reply,"md",true)  
end
end
...
if Redis:sismember(FNKER.."BanGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"˖ تم حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(FNKER.."BanGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"˖ تم الغاء حظره من المجموعة مسبقا ").Reply,"md",true)  
else
Redis:srem(FNKER.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(FNKER.."SilentGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"˖ تم كتمه في المجموعة مسبقا ").Reply,"md",true)  
else
Redis:sadd(FNKER.."SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(FNKER.."SilentGroup:Group"..msg_chat_id,UserId) then
return send(msg_chat_id,msg_id,Reply_Status(UserId,"˖ تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(FNKER.."SilentGroup:Group"..msg_chat_id,UserId) 
return send(msg_chat_id,msg_id,Reply_Status(UserId,"˖ تم الغاء كتمه من المجموعة ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(FNKER.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(FNKER.."Devss:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(FNKER.."Dev:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(FNKER.."Owners:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(FNKER.."Supcreator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(FNKER.."Creator:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(FNKER.."Manger:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(FNKER.."Admin:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(FNKER.."Special:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(FNKER.."Admin:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(FNKER.."Special:Group"..msg_chat_id, msg.sender.user_id)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(FNKER.."Supcreator:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(FNKER.."Admin:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(FNKER.."LeftBot") then
...
if Redis:get(FNKER.."addchannel"..msg.sender.user_id) == "on" then
if text and text:match("^@[%a%d_]+$") then
local m , res = https.request("https://api.telegram.org/bot"..Token.."/getchat?chat_id="..text)
data = json:decode(m)
if res == 200 then
ch = data.result.id
Redis:set(FNKER.."chadmin"..msg_chat_id,ch) 
...
Redis:del(FNKER.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
if Redis:get(FNKER.."chadmin"..msg_chat_id) then
send(msg_chat_id,msg_id,Redis:get(FNKER.."chadmin"..msg_chat_id),"md",true)  
else 
...
if Redis:get(FNKER.."chadmin"..msg_chat_id) then
Redis:del(FNKER.."chadmin"..msg_chat_id) 
...
Redis:set(FNKER.."addchannel"..msg.sender.user_id,"on") 
...
Redis:set(FNKER.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(FNKER.."Lock:text"..msg_chat_id,true) 
...
Redis:set(FNKER.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(FNKER.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(FNKER.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(FNKER.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(FNKER.."lockalllll"..msg_chat_id,"off")
...
Redis:set(FNKER.."lockalllll"..msg_chat_id,"on")
...
Redis:set(FNKER.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(FNKER.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(FNKER.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(FNKER..''..lock..msg_chat_id,"del")    
end
...
Redis:del(FNKER.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(FNKER.."Lock:channell"..msg_chat_id)  
...
Redis:hset(FNKER.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(FNKER.."Lock:text"..msg_chat_id)  
...
Redis:del(FNKER.."Lock:Join"..msg_chat_id)  
...
Redis:del(FNKER.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(FNKER.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(FNKER.."lockpin"..msg_chat_id)  
...
Redis:del(FNKER.."Lock:edit"..msg_chat_id) 
...
Redis:del(FNKER.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(FNKER..''..lock..msg_chat_id)    
end
...
Redis:hset(FNKER.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(FNKER.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(FNKER.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(FNKER.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(FNKER.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(FNKER.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Link"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(FNKER..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(FNKER..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(FNKER..'lock:Fshar'..msg.chat_id) 
...
Redis:del(FNKER..'lock:Fars'..msg.chat_id) 
...
Redis:set(FNKER.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Photo"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Video"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Animation"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:geam"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Audio"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:vico"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:forward"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Document"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Contact"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Spam"..msg_chat_id)  
...
Redis:set(FNKER.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(FNKER.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(FNKER.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(FNKER.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(FNKER.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(FNKER.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(FNKER.."Group:Link"..msg_chat_id) 
return send(msg_chat_id,msg_id,"˖ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(FNKER.."Status:Link"..msg_chat_id) then
return send(msg_chat_id,msg_id,"˖ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(FNKER.."Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(FNKER.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(FNKER.."Status:Welcome"..msg_chat_id) then
...
Redis:del(FNKER.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(FNKER.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(FNKER.."Group:Rules"..msg_chat_id) 
return send(msg_chat_id,msg_id,"˖ تم ازالة قوانين المجموعة","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(FNKER.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(FNKER.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(FNKER.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(FNKER.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(FNKER.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(FNKER.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(FNKER.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(FNKER..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(FNKER..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return send(msg_chat_id,msg_id,'\n*˖ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(FNKER.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(FNKER.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(FNKER.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(FNKER.."All:Get:Reides:Commands:Group"..v)
Redis:del(FNKER.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(FNKER.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(FNKER.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return send(msg_chat_id,msg_id,"˖الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(FNKER.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return send(msg_chat_id,msg_id,"˖ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(FNKER.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(FNKER.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") » {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(FNKER.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(FNKER.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(FNKER.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(FNKER.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if not Redis:get(FNKER.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if not Redis:get(FNKER.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(FNKER.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(FNKER.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(FNKER.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(FNKER.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(FNKER.."Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = 'Source FNKER', url = 't.me/'..chsource..''}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(FNKER.."Dev:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(FNKER.."Supcreator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(FNKER.."Creator:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(FNKER.."Manger:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(FNKER.."Admin:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(FNKER.."Special:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(FNKER.."Dev:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(FNKER.."Supcreator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(FNKER.."Creator:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(FNKER.."Manger:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(FNKER.."Admin:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(FNKER.."Special:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(FNKER..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
send(msg_chat_id,msg_id,'˖ تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح تعديلاتي' or text == 'مسح تعديلاتي' then
Redis:del(FNKER..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
send(msg_chat_id,msg_id,'˖ تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(FNKER..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
send(msg_chat_id,msg_id,'˖ تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
send(msg_chat_id,msg_id,'˖عدد رسائلك هنا *~ '..(Redis:get(FNKER..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'تعديلاتي' or text == 'تعديلاتي' then
send(msg_chat_id,msg_id,'˖عدد التعديلات هنا *~ '..(Redis:get(FNKER..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
send(msg_chat_id,msg_id,'˖عدد جهاتك المضافه هنا *~ '..(Redis:get(FNKER.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(FNKER.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return send(msg_chat_id,msg_id,[[
˖ ارسل الان النص
˖يمكنك اضافه :
...
Redis:setex(FNKER.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return send(msg_chat_id,msg_id,[[
˖ ارسل الان النص
˖يمكنك اضافه :
˖`#username` » اسم المستخدم
...
Redis:del(FNKER.."Set:Id:Group"..msg.chat_id)
...
Redis:del(FNKER.."Supcreator:Group"..msg_chat_id) 
...
Redis:del(FNKER.."Creator:Group"..msg_chat_id) 
...
Redis:del(FNKER.."Manger:Group"..msg_chat_id) 
...
Redis:del(FNKER.."Admin:Group"..msg_chat_id) 
...
Redis:del(FNKER.."Special:Group"..msg_chat_id) 
...
Redis:del(FNKER.."klb:Group"..msg_chat_id) 
...
Redis:del(FNKER.."kholat:Group"..msg_chat_id) 
...
Redis:del(FNKER.."2rd:Group"..msg_chat_id) 
...
Redis:del(FNKER.."8by:Group"..msg_chat_id) 
...
Redis:del(FNKER.."3ra:Group"..msg_chat_id) 
...
Redis:del(FNKER.."smb:Group"..msg_chat_id) 
...
Redis:del(FNKER.."mar:Group"..msg_chat_id) 
...
Redis:del(FNKER.."twhd:Group"..msg_chat_id) 
...
Redis:del(FNKER.."wtka:Group"..msg_chat_id) 
...
Redis:del(FNKER.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(FNKER.."SilentGroup:Group"..msg_chat_id) 
...
Redis:set(FNKER.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(FNKER.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(FNKER.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(FNKER.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(FNKER.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(FNKER.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(FNKER.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:Photoc"..v..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:Videoc"..v..msg_chat_id)  
Redis:del(FNKER.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(FNKER.."Add:Rd:Manager:Audioc"..v..msg_chat_id)
Redis:del(FNKER.."List:Manager"..msg_chat_id.."")
end
...
if text == ("مسح الردود الانلاين") then
  ...
  local list = Redis:smembers(FNKER.."List:Manager:inline"..msg_chat_id.."")
  for k,v in pairs(list) do
      Redis:del(FNKER.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id)   
      Redis:del(FNKER.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id)   
      Redis:del(FNKER.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id)     
      Redis:del(FNKER.."Add:Rd:Manager:Text:inline"..v..msg_chat_id)   
      Redis:del(FNKER.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
      Redis:del(FNKER.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
      Redis:del(FNKER.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
      Redis:del(FNKER.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)  
      Redis:del(FNKER.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
      Redis:del(FNKER.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
      Redis:del(FNKER.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
      Redis:del(FNKER.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
      Redis:del(FNKER.."Rd:Manager:inline:v"..v..msg_chat_id)
      Redis:del(FNKER.."Rd:Manager:inline:link"..v..msg_chat_id)
  Redis:del(FNKER.."List:Manager:inline"..msg_chat_id)
  end
...
if text == "اضف رد انلاين" then
  ...
  return send(msg_chat_id,msg_id,'\n*˖ هاذا الامر يخص  '..Controller_Num(7)..' * ',"md",true)  
    ...
    Redis:set(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,true)
  local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(FNKER) then
  if Redis:get(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true" then
  Redis:set(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true1")
  Redis:set(FNKER.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id, text)
  Redis:del(FNKER.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
  Redis:del(FNKER.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
  Redis:del(FNKER.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
  Redis:del(FNKER.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
  Redis:del(FNKER.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
  Redis:del(FNKER.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
  Redis:del(FNKER.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
  Redis:del(FNKER.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
  Redis:del(FNKER.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
  Redis:del(FNKER.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
  Redis:del(FNKER.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
  Redis:del(FNKER.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
  Redis:del(FNKER.."Rd:Manager:inline:text"..text..msg_chat_id)
  Redis:del(FNKER.."Rd:Manager:inline:link"..text..msg_chat_id)
  Redis:sadd(FNKER.."List:Manager:inline"..msg_chat_id.."", text)
  send(msg_chat_id,msg_id,[[
  ↯︙ارسل لي الرد سواء كان 
  ❨ ملف ، ملصق ، متحركه ، صوره
   ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
  Redis:del(FNKER.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
  Redis:del(FNKER.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
  Redis:del(FNKER.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
  Redis:del(FNKER.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
  ...
  Redis:del(FNKER.."Rd:Manager:inline:text"..text..msg_chat_id)
  Redis:del(FNKER.."Rd:Manager:inline:link"..text..msg_chat_id)
Redis:del(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."")
Redis:srem(FNKER.."List:Manager:inline"..msg_chat_id.."", text)
send(msg_chat_id,msg_id,"˖ تم حذف الرد من الردود الانلاين ","md",true)  
return false
end
end
if Redis:get(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(FNKER) then
Redis:del(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(FNKER.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FNKER.."Add:Rd:Manager:Text:inline"..anubis..msg_chat_id, text)
elseif msg.content.sticker then   
Redis:set(FNKER.."Add:Rd:Manager:Stekrs:inline"..anubis..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(FNKER.."Add:Rd:Manager:Vico:inline"..anubis..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(FNKER.."Add:Rd:Manager:Audio:inline"..anubis..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(FNKER.."Add:Rd:Manager:Audioc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(FNKER.."Add:Rd:Manager:File:inline"..anubis..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(FNKER.."Add:Rd:Manager:Gif:inline"..anubis..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(FNKER.."Add:Rd:Manager:video_note:inline"..anubis..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(FNKER.."Add:Rd:Manager:Video:inline"..anubis..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(FNKER.."Add:Rd:Manager:Videoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(FNKER.."Add:Rd:Manager:Photo:inline"..anubis..msg_chat_id, idPhoto)  
Redis:set(FNKER.."Add:Rd:Manager:Photoc:inline"..anubis..msg_chat_id, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"˖ الان ارسل الكلام داخل الزر","md",true)  
return false  
end  
end
if text and Redis:get(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
Redis:set(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id, "set_link")
local anubis = Redis:get(FNKER.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(FNKER.."Rd:Manager:inline:text"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id,"˖ الان ارسل الرابط","md",true)  
return false  
end
if text and Redis:get(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
Redis:del(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id)
local anubis = Redis:get(FNKER.."Text:Manager:inline"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(FNKER.."Rd:Manager:inline:link"..anubis..msg_chat_id, text)
send(msg_chat_id,msg_id,"˖ تم اضافه الرد بنجاح","md",true)  
return false  
end
if text and not Redis:get(FNKER.."Status:Reply:inline"..msg_chat_id) then
local btext = Redis:get(FNKER.."Rd:Manager:inline:text"..text..msg_chat_id)
local blink = Redis:get(FNKER.."Rd:Manager:inline:link"..text..msg_chat_id)
local anemi = Redis:get(FNKER.."Add:Rd:Manager:Gif:inline"..text..msg_chat_id)   
local veico = Redis:get(FNKER.."Add:Rd:Manager:Vico:inline"..text..msg_chat_id)   
local stekr = Redis:get(FNKER.."Add:Rd:Manager:Stekrs:inline"..text..msg_chat_id)     
local Texingt = Redis:get(FNKER.."Add:Rd:Manager:Text:inline"..text..msg_chat_id)   
local photo = Redis:get(FNKER.."Add:Rd:Manager:Photo:inline"..text..msg_chat_id)
local photoc = Redis:get(FNKER.."Add:Rd:Manager:Photoc:inline"..text..msg_chat_id)
local video = Redis:get(FNKER.."Add:Rd:Manager:Video:inline"..text..msg_chat_id)
local videoc = Redis:get(FNKER.."Add:Rd:Manager:Videoc:inline"..text..msg_chat_id)  
local document = Redis:get(FNKER.."Add:Rd:Manager:File:inline"..text..msg_chat_id)
local audio = Redis:get(FNKER.."Add:Rd:Manager:Audio:inline"..text..msg_chat_id)
local audioc = Redis:get(FNKER.."Add:Rd:Manager:Audioc:inline"..text..msg_chat_id)
local video_note = Redis:get(FNKER.."Add:Rd:Manager:video_note:inline"..text..msg_chat_id)
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text == "حذف رد انلاين" then
  ...
  Redis:set(FNKER.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
if text == ("الردود الانلاين") then
  ...
  for k,v in pairs(list) do
  if Redis:get(FNKER.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id) then
  db = "متحركه ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id) then
  db = "بصمه ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id) then
  db = "ملصق ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Text:inline"..v..msg_chat_id) then
  db = "رساله ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id) then
  db = "صوره ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Video:inline"..v..msg_chat_id) then
  db = "فيديو ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:File:inline"..v..msg_chat_id) then
  db = "ملف ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id) then
  db = "اغنيه ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id) then
  db = "بصمه فيديو ˖"
  end
  text = text..""..k.." » {"..v.."} » {"..db.."}\n"
  end
...
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(FNKER) then
    return send(msg_chat_id,msg_id,"اكو هواي غيري حب","md",true)  
  end
  if Redis:sismember(FNKER..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    local rd_mtzwga = {
"اسف حيلي اني متزوج",
      "متزوج اني عمري",
    }
    ...
    if Redis:sismember(FNKER..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(FNKER..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(FNKER..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(FNKER..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(FNKER..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(FNKER..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(FNKER..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
    local rd_tmtlaq = {
      "تم طلاقكم للاسف",
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(FNKER..msg_chat_id.."mutlqat:")
...
if Redis:get(FNKER.."kit_defullt:") == "true" then
    Redis:set(FNKER.."kit_defullt:","false")
...
if text == "اضف كت" then
    ...
    Redis:set(FNKER.."Set:kit"..msg.sender.user_id..":"..msg_chat_id,true)
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
    ...
    if text and Redis:get(FNKER.."Set:kit"..msg.sender.user_id..":"..msg_chat_id) == "true" then
        Redis:del(FNKER.."Set:kit"..msg.sender.user_id..":"..msg_chat_id)
        Redis:sadd(FNKER.."kit:", text)
        return send(msg_chat_id,msg_id,"˖ تم حفظ السؤال","md",false, false, false, false, reply_markup)
    end
    if text == "مالوركا كت" then
        local list = Redis:smembers(FNKER.."kit:")
...
if text == 'قائمه الكت' then
    ...
    local kit_list = Redis:smembers(FNKER.."kit:") 
    if #kit_list == 0 then
...
if text == "حذف كت" then
    ...
    Redis:set(FNKER.."Set:kit"..msg.sender.user_id..":"..msg_chat_id, "rmkit")
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
    ...
    if text and Redis:get(FNKER.."Set:kit"..msg.sender.user_id..":"..msg_chat_id) == "rmkit" then
        Redis:del(FNKER.."Set:kit"..msg.sender.user_id..":"..msg_chat_id)
        Redis:srem(FNKER.."kit:", text)
...
if text == 'مسح قائمه الكت' then
    ...
    Redis:del(FNKER.."kit:")
    Redis:set(FNKER.."kit_defullt:","true")
...
Redis:set(FNKER.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
send_inlin_key(msg_chat_id,"˖ ارسل الكلمه التي تريد حذفها",inlin,msg_id)
Redis:set(FNKER.."Set:array:rd"..msg.sender.user_id..":"..msg_chat_id,"delrd")
return false 
end
if text then
if  Redis:sismember(FNKER..'List:array',text) then
local list = Redis:smembers(FNKER.."Add:Rd:array:Text"..text)
...
local list = Redis:smembers(FNKER..'List:array')
...
local list = Redis:smembers(FNKER..'List:array')
for k,v in pairs(list) do
Redis:del(FNKER.."Add:Rd:array:Text"..v..msg_chat_id)   
Redis:del(FNKER..'List:array'..msg_chat_id)
end
...
Redis:set(FNKER.."Set:array"..msg.sender.user_id..":"..msg_chat_id,true)
return false
end
...
Redis:set(FNKER.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FNKER.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and not Redis:sismember(FNKER.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(FNKER.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(FNKER.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(FNKER.."Add:Rd:Sudo:Gif"..v)
Redis:del(FNKER.."Add:Rd:Sudo:vico"..v)
Redis:del(FNKER.."Add:Rd:Sudo:stekr"..v)
Redis:del(FNKER.."Add:Rd:Sudo:Text"..v)
Redis:del(FNKER.."Add:Rd:Sudo:Photo"..v)
Redis:del(FNKER.."Add:Rd:Sudo:Photoc"..v)
Redis:del(FNKER.."Add:Rd:Sudo:Video"..v)
Redis:del(FNKER.."Add:Rd:Sudo:Videoc"..v)
Redis:del(FNKER.."Add:Rd:Sudo:File"..v)
Redis:del(FNKER.."Add:Rd:Sudo:Audio"..v)
Redis:del(FNKER.."Add:Rd:Sudo:Audioc"..v)
Redis:del(FNKER.."Add:Rd:Sudo:video_note"..v)
Redis:del(FNKER.."List:Rd:Sudo")
end
...
text = "\n˖ قائمة الردود العامه \nــــــــــــــــــــــــ\n"
for k,v in pairs(list) do
if Redis:get(FNKER.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:vico"..v) then
db = "بصمه ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:Text"..v) then
db = "رساله ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:Photo"..v) then
db = "صوره ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:Video"..v) then
db = "فيديو ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:File"..v) then
db = "ملف ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو ˖"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
if not msg.ControllerBot and not Redis:set(FNKER.."SendBcBot") then
return send(msg_chat_id,msg_id,'\n*˖ امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(FNKER.."ch:admin")
...
Redis:setex(FNKER.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(FNKER.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(FNKER.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
send(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
Redis:setex(FNKER.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(FNKER.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(FNKER..'GetTexting:DevFNKER'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(FNKER..'Texting:DevFNKER')
return send(msg_chat_id,msg_id,'˖ تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevFNKER = Redis:get(FNKER..'Texting:DevFNKER')
if TextingDevFNKER then 
return send(msg_chat_id,msg_id,TextingDevFNKER,"md",true)  
else
...
-- z eng
if text and text:match("%a") and Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."zkrf:") == "zeng" then
  Redis:del(FNKER..msg_chat_id..msg.sender.user_id.."zkrf:")
  Redis:set(FNKER..msg_chat_id..msg.sender.user_id.."zkrf:text", text)
...
-- z ar 
if text and not text:match("%a") and Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."zkrf:") == "zar" then
  Redis:del(FNKER..msg_chat_id..msg.sender.user_id.."zkrf:")
  Redis:set(FNKER..msg_chat_id..msg.sender.user_id.."zkrf:text", text)
  local api = https.request("https://api-jack.ml/api19.php?text="..URL.escape(text))
  local zkrf = JSON.decode(api)
...
Redis:del(FNKER.."myphoto"..msg_chat_id)
...
Redis:set(FNKER.."myphoto"..msg_chat_id,"off")
...
Redis:del(FNKER.."mybuti"..msg_chat_id)
...
Redis:set(FNKER.."mybuti"..msg_chat_id,"off")
...
Redis:del(FNKER.."sayy"..msg_chat_id)
...
Redis:set(FNKER.."sayy"..msg_chat_id,"off")
send(msg_chat_id,msg_id,'\n*˖ تم امر امر قول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(FNKER.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(FNKER.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(FNKER.."myphoto"..msg_chat_id) == "off" then
...
local Added_Me = Redis:get(FNKER.."Who:Added:Me"..msg_chat_id..':'..msg.sender.user_id)
if Added_Me then 
...
if text and Redis:get(FNKER.."toar"..msg.sender.user_id) then
Redis:del(FNKER.."toar"..msg.sender.user_id)
...
if text and Redis:get(FNKER.."toen"..msg.sender.user_id) then
Redis:del(FNKER.."toen"..msg.sender.user_id)
...
{{text = ' Source FNKER', url = "https://t.me/QQQiiQ"}},
}
}
return send(msg_chat_id,msg_id, [[*
...
if Redis:get(FNKER.."youtube"..msg.sender.user_id..msg_chat_id) == "mp3" then
Redis:del(FNKER.."youtube"..msg.sender.user_id..msg_chat_id)
local rep = msg.id/2097152/0.5
...
if Redis:get(FNKER.."youtube"..msg.sender.user_id..msg_chat_id) == "mp4" then
local rep = msg.id/2097152/0.5
local m = json:decode(https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg_chat_id.."&animation=https://t.me/photojack14366/65&reply_to_message_id="..rep)).result.message_id
local se = http.request("https://api-jack.ml/api18.php?search="..URL.escape(text))
local j = JSON.decode(se)
...
Redis:sadd(FNKER.."FNKER:cleaner"..msg.chat_id,msg.id)
end
---------
if text == "رفع بقلبي" then
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
  if tonumber(Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) == tonumber(msg.sender.user_id) then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(FNKER) then
  return send(msg_chat_id,msg_id,"وخري عني حبي","md")
elseif Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
  return send(msg_chat_id,msg_id,"للاسف العضو بقلب ثاني","md")
elseif tonumber(Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id) and not Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."in_heart:") then
    Redis:set(FNKER..msg_chat_id..Message_Reply.sender.user_id.."in_heart:", msg.sender.user_id)
    Redis:sadd(FNKER..msg_chat_id..msg.sender.user_id.."my_heart:", Message_Reply.sender.user_id)
...
if text == "تنزيل من قلبي" then 
  local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
  if tonumber(Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) == tonumber(msg.sender.user_id) then
    Redis:del(FNKER..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")
    Redis:srem(FNKER..msg_chat_id..msg.sender.user_id.."my_heart:", msg_chat_id..Message_Reply.sender.user_id)
...
elseif tonumber(Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."in_heart:")) ~= tonumber(msg.sender.user_id)then
  return send(msg_chat_id,msg_id,"هو بقلبك علمود تنزله ؟","md")
  end
end
if text == "انا بقلب منو" then
  if not Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."in_heart:") then
    return send(msg_chat_id,msg_id,"اكعد يمعود منو الي يطيقك","md")
  elseif Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."in_heart:") then
    local in_heart_id = Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."in_heart:")
...
if text == "تاك للبقلبي" or text == "تاك الي بقلبي" or text == "تاك للناس الي بقلبي" then
  local heart_list = Redis:smembers(FNKER..msg_chat_id..msg.sender.user_id.."my_heart:")
...
if text == "مسح للبقلبي" or text == "مسح الي بقلبي" then 
  local list = Redis:smembers(FNKER..msg_chat_id..msg.sender.user_id.."my_heart:")
  for k,v in pairs(list) do
  Redis:del(FNKER..msg_chat_id..v.."in_heart:")
  end
Redis:del(FNKER..msg_chat_id..msg.sender.user_id.."my_heart:")
...
Redis:set(FNKER..'zwgnyy'..msg.chat_id,true)
...
Redis:del(FNKER..'zwgnyy'..msg.chat_id)
sendx(msg_chat_id,msg_id,'\n ˖ تم تفعيل امر جوزني')
end
if text == "جوزني" or text == "زوجني" then
if not Redis:get(FNKER..'zwgnyy'..msg.chat_id) then 
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
if tonumber(member_id) == tonumber(msg.sender.user_id) or tonumber(member_id) == tonumber(FNKER) or LuaTele.getUser(member_id).type.luatele == "userTypeBot" then 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
...
elseif Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:") then
local zwg_id =  Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
...
elseif Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:") then
  local zwg_id =  Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:")
  local zwg_info = LuaTele.getUser(zwg_id)
  return send(msg_chat_id,msg_id,"رح اصيح لمرتك\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\nالحكي حبي رح يتزوج عليج","md")
elseif not Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")  then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == "زوجتي" then
  if Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwga_id = Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:")
  ...
  elseif not Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:") then
...
elseif tonumber(Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) ~= tonumber(msg.sender.user_id) or tonumber(Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender.user_id) then
  return send(msg_chat_id,msg_id,"مو مرتك هاي ياغبي","md")
elseif tonumber(Redis:get(FNKER..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
    Redis:del(FNKER..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
    Redis:del(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:")
...
if text == "بوت طلكني" then
  if not Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:") then 
  return send(msg_chat_id,msg_id,"انت مامزوج حيلي","md")
  elseif Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwg_id = Redis:get(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:")
    local zwg_name = LuaTele.getUser(zwg_id).first_name
    Redis:del(FNKER..msg_chat_id..msg.sender.user_id.."mtzwga:")
    Redis:del(FNKER..msg_chat_id..zwg_id.."mtzwga:")
...
local list = Redis:smembers(FNKER.."FNKER:cleaner"..msg.chat_id)
if #list == 0 then 
...
Redis:del(FNKER.."FNKER:cleaner"..msg.chat_id)
send(msg_chat_id,msg_id,"˖  تم مسح "..#list.." من الميديا","md",true)
end

if text == "الميديا" then
local list = Redis:smembers(FNKER.."FNKER:cleaner"..msg_chat_id)
return send(msg_chat_id,msg_id,"الميديا هو "..#list.."","md",true)
end
---
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= FNKER then
local test = Redis:get(FNKER.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(FNKER.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(FNKER.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FNKER.."Add:Rd:Sudo:mz:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(FNKER.."Add:Rd:Sudo:mz:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(FNKER.."Add:Rd:Sudo:mz:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(FNKER.."Add:Rd:Sudo:mz:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(FNKER.."Add:Rd:Sudo:mz:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(FNKER.."Add:Rd:Sudo:mz:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(FNKER.."Add:Rd:Sudo:mz:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(FNKER.."Add:Rd:Sudo:mz:Video"..test, msg.content.video.video.remote.id)  
Redis:set(FNKER.."Add:Rd:Sudo:mz:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(FNKER.."Add:Rd:Sudo:mz:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(FNKER.."Add:Rd:Sudo:mz:Photo"..test, idPhoto)  
Redis:set(FNKER.."Add:Rd:Sudo:mz:Photoc"..test, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"˖ تم حفظ الرد \n˖ ارسل ( "..test.." ) لرئية الرد","md",true)  
return false
end  
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(FNKER.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(FNKER.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(FNKER.."List:Rd:Sudo:mz", text)
send(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف ، ملصق ، متحركه ، صوره
 ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(FNKER.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(FNKER.."List:Rd:Sudo:mz", text)
return send(msg_chat_id,msg_id,"˖ تم حذف الرد من الردود العامه","md",true)  
end
end

if text and text ~= "حذف رد مميز" and text ~= "اضف رد مميز" and text ~= "مسح الردود المميزه" and not Redis:get(FNKER.."Status:ReplySudo"..msg_chat_id) then
if not Redis:sismember(FNKER..'Spam:Group'..msg.sender.user_id,text) then
local listmz = Redis:smembers(FNKER.."List:Rd:Sudo:mz")
for k,v in pairs(listmz) do
i ,j  = string.find(text, v)
if j and i then
local x = string.sub(text, i,j)
if x then
local anemi = Redis:get(FNKER.."Add:Rd:Sudo:mz:Gif"..x)   
local veico = Redis:get(FNKER.."Add:Rd:Sudo:mz:vico"..x)   
local stekr = Redis:get(FNKER.."Add:Rd:Sudo:mz:stekr"..x)     
local Text = Redis:get(FNKER.."Add:Rd:Sudo:mz:Text"..x)   
local photo = Redis:get(FNKER.."Add:Rd:Sudo:mz:Photo"..x)
local photoc = Redis:get(FNKER.."Add:Rd:Sudo:mz:Photoc"..x)
local video = Redis:get(FNKER.."Add:Rd:Sudo:mz:Video"..x)
local videoc = Redis:get(FNKER.."Add:Rd:Sudo:mz:Videoc"..x)
local document = Redis:get(FNKER.."Add:Rd:Sudo:mz:File"..x)
local audio = Redis:get(FNKER.."Add:Rd:Sudo:mz:Audio"..x)
local audioc = Redis:get(FNKER.."Add:Rd:Sudo:mz:Audioc"..x)
local video_note = Redis:get(FNKER.."Add:Rd:Sudo:mz:video_note"..x)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(FNKER..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
...
Redis:set(FNKER.."Set:Rd:mz"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:set(FNKER.."Set:On:mz"..msg.sender.user_id..":"..msg_chat_id,true)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(FNKER.."List:Rd:Sudo:mz")
for k,v in pairs(list) do
Redis:del(FNKER.."Add:Rd:Sudo:mz:Gif"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:vico"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:stekr"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:Text"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:Photo"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:Photoc"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:Video"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:Videoc"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:File"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:Audio"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:Audioc"..v)
Redis:del(FNKER.."Add:Rd:Sudo:mz:video_note"..v)
Redis:del(FNKER.."List:Rd:Sudo:mz")
end
...
for k,v in pairs(list) do
if Redis:get(FNKER.."Add:Rd:Sudo:mz:Gif"..v) then
db = "متحركه ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:mz:vico"..v) then
db = "بصمه ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:mz:stekr"..v) then
db = "ملصق ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:mz:Text"..v) then
db = "رساله ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:mz:Photo"..v) then
db = "صوره ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:mz:Video"..v) then
db = "فيديو ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:mz:File"..v) then
db = "ملف ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:mz:Audio"..v) then
db = "اغنيه ˖"
elseif Redis:get(FNKER.."Add:Rd:Sudo:mz:video_note"..v) then
db = "بصمه فيديو ˖"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:del(FNKER..'3dd:klm'..msg.chat_id)
...
if i and j then
Redis:sadd(FNKER..'3dd:klm'..msg.chat_id,mg)
x = string.sub(tx, i,j)
send(msg_chat_id,mg,".","html",true)
end
end
end
list = Redis:smembers(FNKER..'3dd:klm'..msg.chat_id)
...
Redis:del(FNKER..'3dd:klm:ms'..msg.chat_id)
...
i ,j = string.find(tx, mt)
if i and j then
Redis:sadd(FNKER..'3dd:klm:ms'..msg.chat_id,mg)
LuaTele.deleteMessages(data.chat_id,{[1]= mg})
end
end
end
list = Redis:smembers(FNKER..'3dd:klm:ms'..msg.chat_id)
...
if text == ("مسح الردود الانلاين العامه") then
  ...
  local list = Redis:smembers(FNKER.."List:Manager:inline3am")
  for k,v in pairs(list) do
      Redis:del(FNKER.."Add:Rd:Manager:Gif:inline3am"..v)   
      Redis:del(FNKER.."Add:Rd:Manager:Vico:inline3am"..v)   
      Redis:del(FNKER.."Add:Rd:Manager:Stekrs:inline3am"..v)     
      Redis:del(FNKER.."Add:Rd:Manager:Text:inline3am"..v)   
      Redis:del(FNKER.."Add:Rd:Manager:Photo:inline3am"..v)
      Redis:del(FNKER.."Add:Rd:Manager:Photoc:inline3am"..v)
      Redis:del(FNKER.."Add:Rd:Manager:Video:inline3am"..v)
      Redis:del(FNKER.."Add:Rd:Manager:Videoc:inline3am"..v)  
      Redis:del(FNKER.."Add:Rd:Manager:File:inline3am"..v)
      Redis:del(FNKER.."Add:Rd:Manager:video_note:inline3am"..v)
      Redis:del(FNKER.."Add:Rd:Manager:Audio:inline3am"..v)
      Redis:del(FNKER.."Add:Rd:Manager:Audioc:inline3am"..v)
      Redis:del(FNKER.."Rd:Manager:inline3am:v"..v)
      Redis:del(FNKER.."Rd:Manager:inline3am:link"..v)
  Redis:del(FNKER.."List:Manager:inline3am")
  end
  return send(msg_chat_id,msg_id,"˖ تم مسح قائمه الانلاين","md",true)  
  end
if text and Redis:get(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "set_link" then
Redis:del(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id)
local anubis = Redis:get(FNKER.."Text:Manager:inline3am"..msg.sender.user_id..":")
Redis:set(FNKER.."Rd:Manager:inline3am:link"..anubis, text)
send(msg_chat_id,msg_id,"˖ تم اضافه الرد بنجاح","md",true)  
return false  
end
if text and Redis:get(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "set_inline" then
Redis:set(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id, "set_link")
local anubis = Redis:get(FNKER.."Text:Manager:inline3am"..msg.sender.user_id..":")
Redis:set(FNKER.."Rd:Manager:inline3am:text"..anubis, text)
send(msg_chat_id,msg_id,"˖ الان ارسل الرابط","md",true)  
return false  
end
if Redis:get(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "true1" and tonumber(msg.sender.user_id) ~= tonumber(FNKER) then
Redis:del(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id)
Redis:set(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"set_inline")
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local anubis = Redis:get(FNKER.."Text:Manager:inline3am"..msg.sender.user_id..":")
if msg.content.text then   
text = text:gsub('"',"") 
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(FNKER.."Add:Rd:Manager:Text:inline3am"..anubis, text)
elseif msg.content.sticker then   
Redis:set(FNKER.."Add:Rd:Manager:Stekrs:inline3am"..anubis, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(FNKER.."Add:Rd:Manager:Vico:inline3am"..anubis, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(FNKER.."Add:Rd:Manager:Audio:inline3am"..anubis, msg.content.audio.audio.remote.id)  
Redis:set(FNKER.."Add:Rd:Manager:Audioc:inline3am"..anubis, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(FNKER.."Add:Rd:Manager:File:inline3am"..anubis, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(FNKER.."Add:Rd:Manager:Gif:inline3am"..anubis, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(FNKER.."Add:Rd:Manager:video_note:inline3am"..anubis, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(FNKER.."Add:Rd:Manager:Video:inline3am"..anubis, msg.content.video.video.remote.id)  
Redis:set(FNKER.."Add:Rd:Manager:Videoc:inline3am"..anubis, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(FNKER.."Add:Rd:Manager:Photo:inline3am"..anubis, idPhoto)  
Redis:set(FNKER.."Add:Rd:Manager:Photoc:inline3am"..anubis, msg.content.caption.text)  
end
send(msg_chat_id,msg_id,"˖ الان ارسل الكلام داخل الزر","md",true)  
return false  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
if not Redis:sismember(FNKER.."List:Manager:inline3am", text) then
 Redis:del(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."")
   return send(msg_chat_id,msg_id,"˖ لا يوجد رد لهذه الكلمه","md",true)  
  end
  Redis:del(FNKER.."Add:Rd:Manager:Gif:inline3am"..text)   
  Redis:del(FNKER.."Add:Rd:Manager:Vico:inline3am"..text)   
  Redis:del(FNKER.."Add:Rd:Manager:Stekrs:inline3am"..text)     
  Redis:del(FNKER.."Add:Rd:Manager:Text:inline3am"..text)   
  Redis:del(FNKER.."Add:Rd:Manager:Photo:inline3am"..text)
  Redis:del(FNKER.."Add:Rd:Manager:Photoc:inline3am"..text)
  Redis:del(FNKER.."Add:Rd:Manager:Video:inline3am"..text)
  Redis:del(FNKER.."Add:Rd:Manager:Videoc:inline3am"..text)  
  Redis:del(FNKER.."Add:Rd:Manager:File:inline3am"..text)
  Redis:del(FNKER.."Add:Rd:Manager:video_note:inline3am"..text)
  Redis:del(FNKER.."Add:Rd:Manager:Audio:inline3am"..text)
  Redis:del(FNKER.."Add:Rd:Manager:Audioc:inline3am"..text)
  Redis:del(FNKER.."Rd:Manager:inline3am:text"..text)
  Redis:del(FNKER.."Rd:Manager:inline3am:link"..text)
Redis:del(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id.."")
Redis:srem(FNKER.."List:Manager:inline3am", text)
send(msg_chat_id,msg_id,"˖ تم حذف الرد من الردود الانلاين العامه","md",true)  
return false
end
end
if text and text:match("^(.*)$") and tonumber(msg.sender.user_id) ~= tonumber(FNKER) then
  if Redis:get(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id) == "true" then
  Redis:set(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"true1")
  Redis:set(FNKER.."Text:Manager:inline3am"..msg.sender.user_id..":", text)
  Redis:del(FNKER.."Add:Rd:Manager:Gif:inline3am"..text)   
  Redis:del(FNKER.."Add:Rd:Manager:Vico:inline3am"..text)   
  Redis:del(FNKER.."Add:Rd:Manager:Stekrs:inline3am"..text)     
  Redis:del(FNKER.."Add:Rd:Manager:Text:inline3am"..text)   
  ...
  Redis:del(FNKER.."Rd:Manager:inline3am:text"..text)
  Redis:del(FNKER.."Rd:Manager:inline3am:link"..text)
  Redis:sadd(FNKER.."List:Manager:inline3am", text)
  send(msg_chat_id,msg_id,[[
  ↯︙ارسل لي الرد سواء كان 
  ❨ ملف ، ملصق ، متحركه ، صوره
   ، فيديو ، بصمه الفيديو ، بصمه ، صوت ، رساله ❩
...
if text == "اضف رد انلاين عام" then
  ...
  Redis:set(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,true)
  local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text and not Redis:get(FNKER.."Status:Reply:inline3am"..msg_chat_id) then
local btext = Redis:get(FNKER.."Rd:Manager:inline3am:text"..text)
local blink = Redis:get(FNKER.."Rd:Manager:inline3am:link"..text)
local anemi = Redis:get(FNKER.."Add:Rd:Manager:Gif:inline3am"..text)   
local veico = Redis:get(FNKER.."Add:Rd:Manager:Vico:inline3am"..text)   
local stekr = Redis:get(FNKER.."Add:Rd:Manager:Stekrs:inline3am"..text)     
local Texingt = Redis:get(FNKER.."Add:Rd:Manager:Text:inline3am"..text)   
local photo = Redis:get(FNKER.."Add:Rd:Manager:Photo:inline3am"..text)
local photoc = Redis:get(FNKER.."Add:Rd:Manager:Photoc:inline3am"..text)
local video = Redis:get(FNKER.."Add:Rd:Manager:Video:inline3am"..text)
local videoc = Redis:get(FNKER.."Add:Rd:Manager:Videoc:inline3am"..text)  
local document = Redis:get(FNKER.."Add:Rd:Manager:File:inline3am"..text)
local audio = Redis:get(FNKER.."Add:Rd:Manager:Audio:inline3am"..text)
local audioc = Redis:get(FNKER.."Add:Rd:Manager:Audioc:inline3am"..text)
local video_note = Redis:get(FNKER.."Add:Rd:Manager:video_note:inline3am"..text)
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
  {
...
if text == "حذف رد انلاين عام" then
  ...
  Redis:set(FNKER.."Set:Manager:rd:inline3am"..msg.sender.user_id..":"..msg_chat_id,"true2")
  return send(msg_chat_id,msg_id,"˖ ارسل الان الكلمه لحذفها من الردود الانلاين","md",false, false, false, false, reply_markup)
  end 
...
if text == ("الردود الانلاين العامه") then
  ...
  text = "˖ قائمه الردود الانلاين \nــــــــــــــــــــــــ\n"
  for k,v in pairs(list) do
  if Redis:get(FNKER.."Add:Rd:Manager:Gif:inline3am"..v) then
  db = "متحركه ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Vico:inline3am"..v) then
  db = "بصمه ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Stekrs:inline3am"..v) then
  db = "ملصق ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Text:inline3am"..v) then
  db = "رساله ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Photo:inline3am"..v) then
  db = "صوره ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Video:inline3am"..v) then
  db = "فيديو ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:File:inline3am"..v) then
  db = "ملف ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:Audio:inline3am"..v) then
  db = "اغنيه ˖"
  elseif Redis:get(FNKER.."Add:Rd:Manager:video_note:inline3am"..v) then
  db = "بصمه فيديو ˖"
  end
  text = text..""..k.." » {"..v.."} » {"..db.."}\n"
  end
...
Redis:sadd(FNKER..'ban:online',txx)
...
if txx:match("^-100(%d+)$") then
Redis:srem(FNKER..'ban:online',txx)
...
balas = 10
if Redis:sismember(FNKER.."booob",msg.sender.user_id) then
return send(msg.chat_id,msg.id, "•  لديك حساب بنكي مسبقاً\n\n•  لعرض معلومات حسابك اكتب\n⇠ `حسابي`","md",true)
end
Redis:setex(FNKER.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(FNKER.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "ماستر" then
...
Redis:set(FNKER.."bobna"..msg.sender.user_id,news)
Redis:set(FNKER.."boob"..msg.sender.user_id,balas)
Redis:set(FNKER.."boobb"..msg.sender.user_id,creditcc)
Redis:set(FNKER.."bbobb"..msg.sender.user_id,text)
Redis:set(FNKER.."boballname"..creditcc,news)
Redis:set(FNKER.."boballbalc"..creditcc,balas)
Redis:set(FNKER.."boballcc"..creditcc,creditcc)
Redis:set(FNKER.."boballban"..creditcc,text)
Redis:set(FNKER.."boballid"..creditcc,banid)
Redis:sadd(FNKER.."booob",msg.sender.user_id)
Redis:del(FNKER.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
Redis:set(FNKER.."bobna"..msg.sender.user_id,news)
Redis:set(FNKER.."boob"..msg.sender.user_id,balas)
Redis:set(FNKER.."boobb"..msg.sender.user_id,creditvi)
Redis:set(FNKER.."bbobb"..msg.sender.user_id,text)
Redis:set(FNKER.."boballname"..creditvi,news)
Redis:set(FNKER.."boballbalc"..creditvi,balas)
Redis:set(FNKER.."boballcc"..creditvi,creditvi)
Redis:set(FNKER.."boballban"..creditvi,text)
Redis:set(FNKER.."boballid"..creditvi,banid)
Redis:sadd(FNKER.."booob",msg.sender.user_id)
Redis:del(FNKER.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id, "\n• وسوينا لك حساب في بنك مالوركا 🏦\n• وشحنالك 10 دولار 💵 هدية\n\n•  رقم حسابك ↢ ( `"..creditvi.."` )\n•  نوع البطاقة ↢ ( فيزا 💳 )\n•  فلوسك ↢ ( 10 دولار 💵 )  ","md",true)   
end 
...
Redis:set(FNKER.."bobna"..msg.sender.user_id,news)
Redis:set(FNKER.."boob"..msg.sender.user_id,balas)
Redis:set(FNKER.."boobb"..msg.sender.user_id,creditex)
Redis:set(FNKER.."bbobb"..msg.sender.user_id,text)
Redis:set(FNKER.."boballname"..creditex,news)
Redis:set(FNKER.."boballbalc"..creditex,balas)
Redis:set(FNKER.."boballcc"..creditex,creditex)
Redis:set(FNKER.."boballban"..creditex,text)
Redis:set(FNKER.."boballid"..creditex,banid)
Redis:sadd(FNKER.."booob",msg.sender.user_id)
Redis:del(FNKER.."booobb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
send(msg.chat_id,msg.id, "\n• وسوينا لك حساب في بنك مالوركا 🏦\n• وشحنالك 10 دولار 💵 هدية\n\n•  رقم حسابك ↢ ( `"..creditex.."` )\n•  نوع البطاقة ↢ ( اكسبرس 💳 )\n•  فلوسك ↢ ( 10 دولار 💵 )  ","md",true)   
end 
...
if Redis:sismember(FNKER.."booob",msg.sender.user_id) then
Redis:srem(FNKER.."booob", msg.sender.user_id)
Redis:del(FNKER.."boob"..msg.sender.user_id)
Redis:del(FNKER.."boobb"..msg.sender.user_id)
Redis:del(FNKER.."zrfff"..msg.sender.user_id)
Redis:srem(FNKER.."zrfffid", msg.sender.user_id)
...
if msg.ControllerBot then
Redis:del(FNKER.."booob")
Redis:del(FNKER.."boob")
Redis:del(FNKER.."boobb")
Redis:del(FNKER.."zrfff")
Redis:del(FNKER.."zrfffid")
...
if Redis:sismember(FNKER.."booob",msg.sender.user_id) then
ballancee = Redis:get(FNKER.."boob"..msg.sender.user_id) or 0
...
if Redis:sismember(FNKER.."booob",Remsg.sender.user_id) then
ballanceed = Redis:get(FNKER.."boob"..Remsg.sender.user_id) or 0
...
if Redis:sismember(FNKER.."booob",msg.sender.user_id) then
cccc = Redis:get(FNKER.."boobb"..msg.sender.user_id)
uuuu = Redis:get(FNKER.."bbobb"..msg.sender.user_id)
pppp = Redis:get(FNKER.."zrfff"..msg.sender.user_id) or 0
ballancee = Redis:get(FNKER.."boob"..msg.sender.user_id) or 0
...
if Redis:sismember(FNKER.."booob",Remsg.sender.user_id) then
ccccc = Redis:get(FNKER.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(FNKER.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(FNKER.."zrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(FNKER.."boob"..Remsg.sender.user_id) or 0
Redis:srem(FNKER.."booob", Remsg.sender.user_id)
Redis:del(FNKER.."boob"..Remsg.sender.user_id)
Redis:del(FNKER.."boobb"..Remsg.sender.user_id)
Redis:del(FNKER.."zrfff"..Remsg.sender.user_id)
Redis:srem(FNKER.."zrfffid", Remsg.sender.user_id)
...
if Redis:sismember(FNKER.."booob",coniss) then
ccccc = Redis:get(FNKER.."boobb"..coniss)
uuuuu = Redis:get(FNKER.."bbobb"..coniss)
ppppp = Redis:get(FNKER.."zrfff"..coniss) or 0
ballanceed = Redis:get(FNKER.."boob"..coniss) or 0
Redis:srem(FNKER.."booob", coniss)
Redis:del(FNKER.."boob"..coniss)
Redis:del(FNKER.."boobb"..coniss)
Redis:del(FNKER.."zrfff"..coniss)
Redis:srem(FNKER.."zrfffid", coniss)
send(msg.chat_id,msg.id, "•  الاسم ↢ "..news.."\n•  الحساب ↢ `"..ccccc.."`\n•  بنك ↢ ( مالوركا )\n•  نوع ↢ ( "..uuuuu.." )\n•  الرصيد ↢ ( "..ballanceed.." دولار 💵 )\n•  الزرف ↢ ( "..ppppp.." دولار 💵 )\n•  مسكين مسحت حسابه \n✦","md",true)
else
send(msg.chat_id,msg.id, "•  ماعنده حساب بنكي اصلاً ","md",true)
end
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if Redis:get(FNKER.."boballcc"..coniss) then
local yty = Redis:get(FNKER.."boballname"..coniss)
local dfhb = Redis:get(FNKER.."boballbalc"..coniss)
local fsvhh = Redis:get(FNKER.."boballban"..coniss)
...
local coniss = tonumber(coniss)
if Redis:sismember(FNKER.."booob",msg.sender.user_id) then
if Redis:get(FNKER.."iiooooo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(FNKER.."iiooooo" .. msg.sender.user_id))
...
Redis:set(FNKER.."boob"..msg.sender.user_id , math.floor(ballanceekkku))
Redis:setex(FNKER.."iiooooo" .. msg.sender.user_id,1200, true)
...
local coniss = tonumber(coniss)
if Redis:sismember(FNKER.."booob",msg.sender.user_id) then
if Redis:get(FNKER.."iioooo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(FNKER.."iioooo" .. msg.sender.user_id))
...
Redis:incrby(FNKER.."boob"..msg.sender.user_id , math.floor(ballanceekk))
Redis:setex(FNKER.."iioooo" .. msg.sender.user_id,1200, true)
...
local coniss = tonumber(coniss)
if Redis:sismember(FNKER.."booob",msg.sender.user_id) then
if Redis:get(FNKER.."iiooo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(FNKER.."iiooo" .. msg.sender.user_id)) 
...
Redis:incrby(FNKER.."boob"..msg.sender.user_id , coniss)
Redis:setex(FNKER.."iiooo" .. msg.sender.user_id,1200, true)
...
Redis:decrby(FNKER.."boob"..msg.sender.user_id , coniss)
Redis:setex(FNKER.."iiooo" .. msg.sender.user_id,1200, true)
...
local coniss = coniss:gsub('-','')
local coniss = tonumber(coniss)
if not Redis:sismember(FNKER.."booob",msg.sender.user_id) then
...
Redis:set(FNKER.."transn"..msg.sender.user_id,coniss)
Redis:setex(FNKER.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(FNKER.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(FNKER.."boobb"..msg.sender.user_id)
uuuu = Redis:get(FNKER.."bbobb"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(FNKER.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(FNKER.."transn" .. msg.sender.user_id)
...
if Redis:get(FNKER.."boballcc"..text) then
local UserNamey = Redis:get(FNKER.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local fsvhhh = Redis:get(FNKER.."boballid"..text)
...
local fsvhh = Redis:get(FNKER.."boballban"..text)
UserNameyr = UserNamey / 10
UserNameyy = UserNamey - UserNameyr
Redis:decrby(FNKER.."boob"..msg.sender.user_id , UserNamey)
Redis:incrby(FNKER.."boob"..fsvhhh , math.floor(UserNameyy))
...
if Redis:sismember(FNKER.."booob",Remsg.sender.user_id) then
Redis:incrby(FNKER.."boob"..Remsg.sender.user_id , coniss)
ccccc = Redis:get(FNKER.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(FNKER.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(FNKER.."zrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(FNKER.."boob"..Remsg.sender.user_id) or 0
...
if Redis:sismember(FNKER.."booob",Remsg.sender.user_id) then
Redis:decrby(FNKER.."boob"..Remsg.sender.user_id , coniss)
ccccc = Redis:get(FNKER.."boobb"..Remsg.sender.user_id)
uuuuu = Redis:get(FNKER.."bbobb"..Remsg.sender.user_id)
ppppp = Redis:get(FNKER.."zrfff"..Remsg.sender.user_id) or 0
ballanceed = Redis:get(FNKER.."boob"..Remsg.sender.user_id) or 0
...
local bank_users = Redis:smembers(FNKER.."booob")
...
local mony = Redis:get(FNKER.."boob"..v)
...
local ty_users = Redis:smembers(FNKER.."zrfffid")
if #ty_users == 0 then
...
local mony = Redis:get(FNKER.."zrfff"..v)
...
if Redis:sismember(FNKER.."booob",msg.sender.user_id) then
if Redis:get(FNKER.."iioo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(FNKER.."iioo" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"•  من شوي اخذت بخشيش استنى ( "..time_ex.." )","md",true)
end
local jjjo = math.random(1,200);
Redis:incrby(FNKER.."boob"..msg.sender.user_id , jjjo)
send(msg.chat_id,msg.id,"•  تكرم وهي بخشيش "..jjjo.." دولار 💵","md",true)
Redis:setex(FNKER.."iioo" .. msg.sender.user_id,600, true)
else
send(msg.chat_id,msg.id, "•  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:get(FNKER.."polic" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(FNKER.."polic" .. msg.sender.user_id))
return send(msg.chat_id,msg.id,"•  انتا بالسجن 🏤 انتضر ( "..time_ex.." )","md",true)
end
if Redis:get(FNKER.."hrame" .. Remsg.sender.user_id) then
local time_ex = ctime(Redis:ttl(FNKER.."hrame" .. Remsg.sender.user_id))
...
local ballanceed = Redis:get(FNKER.."boob"..Remsg.sender.user_id) or 0
Redis:incrby(FNKER.."boob"..msg.sender.user_id , hrame)
Redis:decrby(FNKER.."boob"..Remsg.sender.user_id , hrame)
Redis:setex(FNKER.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(FNKER.."zrfff"..msg.sender.user_id,hrame)
Redis:sadd(FNKER.."zrfffid",msg.sender.user_id)
send(msg.chat_id,msg.id, "•  خذ يالحرامي زرفته "..hrame.." دولار 💵\n✦","md",true)
else
Redis:setex(FNKER.."polic" .. msg.sender.user_id,300, true)
...
if Redis:sismember(FNKER.."booob",msg.sender.user_id) then
if Redis:get(FNKER.."iiioo" .. msg.sender.user_id) then
local time_ex = ctime(Redis:ttl(FNKER.."iiioo" .. msg.sender.user_id))
...
if job == "طيار" then
Redis:incrby(FNKER.."boob"..msg.sender.user_id , 500)
ratbk = "500"
your_job = "طيار 🚀"
elseif job == "محامي" then
Redis:incrby(FNKER.."boob"..msg.sender.user_id , 300)
ratbk = "300"
your_job = "محامي 👨‍🎓"
elseif job == "دكتور" then
Redis:incrby(FNKER.."boob"..msg.sender.user_id , 600)
ratbk = "600"
your_job = "دكتور 👨‍🔬‍"
elseif job == "خباز" then
Redis:incrby(FNKER.."boob"..msg.sender.user_id , 100)
ratbk = "100"
your_job = "خباز ‍💆‍♂️"
elseif job == "مدير بنك" then
Redis:incrby(FNKER.."boob"..msg.sender.user_id , 800)
ratbk = "800"
your_job = "مدير بنك ‍👨‍💼"
elseif job == "قلب ايسثتك" then
Redis:incrby(FNKER.."boob"..msg.sender.user_id , 1000)
ratbk = "1000"
your_job = "قلب ايسثتك ♥"
elseif job == "مدرس" then
Redis:incrby(FNKER.."boob"..msg.sender.user_id , 400)
ratbk = "400"
your_job = "مدرس 🤵"
elseif job == "فتاحه" then
Redis:incrby(FNKER.."boob"..msg.sender.user_id , 5000)
ratbk = "5000"
your_job = "فتاحه 💋"
end
local ballancee = Redis:get(FNKER.."boob"..msg.sender.user_id) or 0
send(msg.chat_id,msg.id,"• اشعار ايداع "..neews.."\n• وظيفتك : "..your_job.."\n• المبلغ : "..ratbk.." دولار 💵\n• نوع العملية : اضافة راتب\n• رصيدك الحين : "..ballancee.." دولار 💵","md",true)
Redis:setex(FNKER.."iiioo" .. msg.sender.user_id,600, true)
else
send(msg.chat_id,msg.id, "•  ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if not Redis:sismember(FNKER.."booob",Remsg.sender.user_id) then
return send(msg.chat_id,msg.id,"• ما عنده حساب بنكي")
end
if Redis:get(FNKER..'hgomm'..msg.sender.user_id) then
return send(msg.chat_id,msg.id,"• استنا "..ctime(Redis:ttl(FNKER..'hgomm'..msg.sender.user_id)).." وبعدين هاجم تاني")
end
...
local coniss = coniss:gsub('-','')
local coniss = tonumber(coniss)
local my_balance = Redis:get(FNKER.."boob"..msg.sender.user_id) or 0
local his_balance = Redis:get(FNKER.."boob"..Remsg.sender.user_id) or 0
...
Redis:incrby(FNKER.."boob"..msg.sender.user_id , coniss)
Redis:decrby(FNKER.."boob"..Remsg.sender.user_id , coniss)
local balance = Redis:get(FNKER.."boob"..msg.sender.user_id) or 0
local Hbalance = Redis:get(FNKER.."boob"..Remsg.sender.user_id) or 0
Redis:setex(FNKER..'hgomm'..msg.sender.user_id,300,true)
...
if text and Redis:get(FNKER..msg.chat_id..msg.sender.user_id.."txtrtb") then
local balance = Redis:get(FNKER.."boob"..msg.sender.user_id)
if text == 'مميز' and tonumber(balance)  >= 2000 then
Redis:decrby(FNKER.."boob"..msg.sender.user_id , 2000)
Redis:sadd(FNKER.."Special:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(FNKER..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:decrby(FNKER.."boob"..msg.sender.user_id , 4000)
Redis:sadd(FNKER.."Admin:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(FNKER..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:decrby(FNKER.."boob"..msg.sender.user_id , 6000)
Redis:sadd(FNKER.."Manger:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(FNKER..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:decrby(FNKER.."boob"..msg.sender.user_id , 8000)
Redis:sadd(FNKER.."Creator:Group"..msg_chat_id,msg.sender.user_id) 
Redis:del(FNKER..msg.chat_id..msg.sender.user_id.."txtrtb") 
...
Redis:setex(FNKER..msg.chat_id..msg.sender.user_id.."txtrtb",180,true)
...
Redis:set(FNKER..'rdod:sh'..msg.chat_id,true)
...
Redis:del(FNKER..'rdod:sh'..msg.chat_id)
send(msg_chat_id,msg_id,'\n*˖ تم تعطيل ردود السورس * ',"md",true)  
end
if Redis:get(FNKER..'rdod:sh'..msg.chat_id) then
...
txx = "˖ قائمه الردود \nــــــــــــــــــــــــ\n"
for k,v in pairs(list) do
if Redis:get(FNKER.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه ˖"
elseif Redis:get(FNKER.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه ˖"
elseif Redis:get(FNKER.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق ˖"
elseif Redis:get(FNKER.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ˖"
elseif Redis:get(FNKER.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره ˖"
elseif Redis:get(FNKER.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو ˖"
elseif Redis:get(FNKER.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ˖"
elseif Redis:get(FNKER.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه ˖"
elseif Redis:get(FNKER.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو ˖"
end
txx = txx..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⧫ Source FNKER️ ⧫',url="t.me/QQQiiQ"}},
}
local msg_id = msg.id/2097152/0.5
...
Redis:del(FNKER..msg.sender.user_id..msg.chat_id.."num")
...
Redis:set(FNKER..msg.chat_id..msg.sender.user_id.."replace",true)
...
local list = Redis:smembers(FNKER.."Words:r")
for k,v in pairs(list) do
Redis:del(FNKER.."Word:Replace"..v)
end
Redis:del(FNKER.."Words:r")
...
for k,v in pairs(list) do 
cmdd = Redis:get(FNKER.."Word:Replace"..v)
txx = txx..k.." - "..v.." »» "..cmdd.."\n"
end
...
local datar = {data = {{text = "˖ Source FNKER ˖" , url = 'https://t.me/QQQiiQ'}}}
for i = 1,5 do
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "truedel" then
Redis:set(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"truefguigf1")
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true1")
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(FNKER.."gamebot:newqus"..msg.chat_id)
Redis:set(FNKER.."gamebot:newqus:as1"..quschen,text)
Redis:set(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true2")
return send(msg_chat_id,msg_id, ' \n ارسل الجواب الثاني') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(FNKER.."gamebot:newqus"..msg.chat_id)
Redis:set(FNKER.."gamebot:newqus:as2"..quschen,text)
Redis:set(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true3")
return send(msg_chat_id,msg_id, '\n ارسل الجواب الثالث') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(FNKER.."gamebot:newqus"..msg.chat_id)
Redis:set(FNKER.."gamebot:newqus:as3"..quschen,text)
Redis:set(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true4")
return send(msg_chat_id,msg_id, '\n ارسل الجواب الرابع') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true4" then
local quschen = Redis:get(FNKER.."gamebot:newqus"..msg.chat_id)
Redis:set(FNKER.."gamebot:newqus:as0"..quschen,text)
Redis:set(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true44")
return send(msg_chat_id,msg_id, '\nتم حفظ الاجوبه \n ارسل الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(FNKER.."gamebot:newqus"..msg.chat_id)
Redis:set(FNKER.."gamebot:newqus:as4"..quschen,text)
Redis:set(FNKER.."gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true186")
return send(msg_chat_id,msg_id, '\nتم حفظ الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "truedel" then
Redis:set(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"truefguigf1")
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true1")
...
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(FNKER.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(FNKER.."lkz:gamebot:newqus:as1"..quschen,text)
Redis:set(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true2")
send(msg_chat_id,msg_id, ' \n ارسل الجواب الثاني')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(FNKER.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(FNKER.."lkz:gamebot:newqus:as2"..quschen,text)
Redis:set(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true3")
send(msg_chat_id,msg_id, '\n ارسل الجواب الثالث')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(FNKER.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(FNKER.."lkz:gamebot:newqus:as3"..quschen,text)
Redis:set(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true44")
send(msg_chat_id,msg_id, ' \n ارسل الجواب الصحيح')
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(FNKER.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(FNKER.."lkz:gamebot:newqus:as4"..quschen,text)
Redis:set(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,"true186")
send(msg_chat_id,msg_id, '\nتم حفظ الجواب الصحيح')
return false 
end
end
...
Redis:set(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(FNKER.."lkz:gamebot:new"..msg.sender.user_id..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"ارسل اللغز الان ")
end
...
local list = Redis:smembers(FNKER.."lkz:gamebot:new1")
t = "• الالغاز : \n"
for k,v in pairs(list) do
t = t..""..k.."- (["..v.."])\n"
end
...
Redis:del(FNKER.."lkz:gamebot:new1")
...
if #list ~= 0 then
local quschen = list[math.random(#list)]
local ansar1 = Redis:get(FNKER.."lkz:gamebot:newqus:as1"..quschen)
local ansar2 = Redis:get(FNKER.."lkz:gamebot:newqus:as2"..quschen)
local ansar3 = Redis:get(FNKER.."lkz:gamebot:newqus:as3"..quschen)
local ansar4 = Redis:get(FNKER.."lkz:gamebot:newqus:as4"..quschen)
...
SuperCreator = Redis:sismember(FNKER.."SuperCreator:Group"..msg.chat_id,UserId_Info.id) 
Creator = Redis:sismember(FNKER.."Creator:Group"..msg.chat_id,UserId_Info.id)
Manger = Redis:sismember(FNKER.."Manger:Group"..msg.chat_id,UserId_Info.id)
Admin = Redis:sismember(FNKER.."Admin:Group"..msg.chat_id,UserId_Info.id)
Special = Redis:sismember(FNKER.."Special:Group"..msg.chat_id,UserId_Info.id)
BanGroup = Redis:sismember(FNKER.."BanGroup:Group"..msg.chat_id,UserId_Info.id)
SilentGroup = Redis:sismember(FNKER.."SilentGroup:Group"..msg.chat_id,UserId_Info.id)
if BanGroup then
BanGroupz = "✔"
else
BanGroupz = "❌"
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
SuperCreator = Redis:sismember(FNKER.."SuperCreator:Group"..msg.chat_id,Message_Reply.sender.user_id) 
Creator = Redis:sismember(FNKER.."Creator:Group"..msg.chat_id,Message_Reply.sender.user_id)
Manger = Redis:sismember(FNKER.."Manger:Group"..msg.chat_id,Message_Reply.sender.user_id)
Admin = Redis:sismember(FNKER.."Admin:Group"..msg.chat_id,Message_Reply.sender.user_id)
Special = Redis:sismember(FNKER.."Special:Group"..msg.chat_id,Message_Reply.sender.user_id)
BanGroup = Redis:sismember(FNKER.."BanGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
SilentGroup = Redis:sismember(FNKER.."SilentGroup:Group"..msg.chat_id,Message_Reply.sender.user_id)
if BanGroup then
BanGroupz = "✔"
else
BanGroupz = "❌"
...
keyboard.inline_keyboard = {
{
{text = 'TwS FNKER', url = "https://t.me/z666Bot"},
},
{
{text = 'Source FNKER ', url = "https://t.me/QQQiiQ"}
},
...
Redis:setex(FNKER.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(FNKER.."Name:Bot") 
return send(msg_chat_id,msg_id,"˖ تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(FNKER.."Name:Bot") or "مالوركا") then
if Redis:get(FNKER.."name bot type : ") == "photo" then
  local photo = LuaTele.getUserProfilePhotos(FNKER)
  local UserInfo = LuaTele.getUser(FNKER)
  local Name_User = UserInfo.first_name
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(FNKER.."Name:Bot") or "مالوركا")
    local NameBots = {
"قلب "..NamesBot ,
"منو مزعلك ؟",
"كول عمري",
...
x = x + 1
Redis:srem(FNKER..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,FNKER)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
send(Get_Chat.id,0,'*˖ البوت عضو في المجموعة سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(FNKER..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(FNKER..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(FNKER..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(FNKER..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(FNKER.."mshaher"..msg.chat_id,name)
...
Redis:set(FNKER.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(FNKER.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(FNKER.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(FNKER.."Game:Difference"..msg.chat_id,name)
...
Redis:set(FNKER.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(FNKER.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,Xnxx )  
...
Redis:incrby(FNKER.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف نقاط (%d+)$"))  
...
Redis:incrby(FNKER.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
if text == "نقاطي" then 
local Num = Redis:get(FNKER.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط', 'رفع مطور')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي', 'رفع مطور ثانوي')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ج', 'تتجوزيني')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'قف', 'قفل الاشعارات')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'فف', 'فتح الاشعارات')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر', 'الرابط')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'الردود', 'رر')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تث', 'تثبيت')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تاك', 'تاك للكل')
Redis:set(FNKER.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ', 'غنيلي')
return send(msg_chat_id,msg_id,[[*
...
Redis:del(FNKER.."smsme"..msg.chat_id)
...
Redis:set(FNKER.."smsme"..msg.chat_id,true)
send(msg.chat_id,msg.id,"˖ تم تعطيل سمسمي")
end
if not Redis:get(FNKER.."smsme"..msg.chat_id) then
if text and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Message_Reply and Message_Reply.sender and tonumber(Message_Reply.sender.user_id) == tonumber(FNKER) then
...
local GetLink = Redis:get(FNKER.."Group:Link"..coree[1]) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =Get_Chat.title, url = GetLink}, },}}
return send(msg_chat_id, msg_id, "˖Link Group : \n["..Get_Chat.title.. ']('..GetLink..')', 'md', true, false, false, false, reply_markup)
...
if text and Redis:get(FNKER..msg.sender.user_id.."hash") and Redis:get(FNKER..msg.sender.user_id.."num") and Redis:get(FNKER..msg.sender.user_id..'pass') then
if text == "الغاء" or text == "˖ الغاء" then
Redis:del(FNKER..msg.sender.user_id.."hash")
Redis:del(FNKER..msg.sender.user_id.."num")
Redis:del(FNKER..msg.sender.user_id.."pass")
local k = {
...
local hash = Redis:get(FNKER..msg.sender.user_id.."hash")
local num = Redis:get(FNKER..msg.sender.user_id.."num")
local pass = Redis:get(FNKER..msg.sender.user_id.."pass")
...
if text and Redis:get(FNKER..msg.sender.user_id.."hash") and Redis:get(FNKER..msg.sender.user_id.."num") and not Redis:get(FNKER..msg.sender.user_id..'pass') then
if text == "الغاء" or text == "˖ الغاء" then
Redis:del(FNKER..msg.sender.user_id.."hash")
Redis:del(FNKER..msg.sender.user_id.."num")
local k = {
...
Redis:set(FNKER..msg.sender.user_id..'pass',text)
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
...
Redis:set(FNKER..msg.sender.user_id.."hash",json.result.access_hash)
Redis:set(FNKER..msg.sender.user_id.."num",num)
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
{
...
local CmdStart = '*\n˖ أهلآ بك في بوت '..(Redis:get(FNKER.."Name:Bot") or "مالوركا")..
...
LuaTele.sendPhoto(msg.chat_id, msg.id, photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id,Redis:get(FNKER.."Start:Bot"),"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup )
end
else
local reply_markup = LuaTele.replyMarkup{type = 'keyboard',resize = true,is_personal = true,
data = {
...
if text == "تفعيل البوت بصوره ˖" then
  ...
  Redis:set(FNKER.."name bot type : ", "photo")
...
Redis:set(FNKER.."name bot type : ", "text")
...
Redis:setex(FNKER.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
return send(msg_chat_id,msg_id,"Source FNKER » @"..chsource.."","html",true, false, false, true, reply_markup)
end
...
if not Redis:get(FNKER.."chmembers") then
return send(msg_chat_id,msg_id,'\n*˖ الامر معطل بالفعل* ',"md",true)  
end
Redis:del(FNKER.."chmembers")
...
if not Redis:get(FNKER.."chfalse") then
return send(msg_chat_id,msg_id,'\n*˖ عذرا عليك تعيين قناه للاشتراك الاجباري اولا* ',"md",true)  
end
Redis:set(FNKER.."chmembers","on")
...
if Redis:get(FNKER.."set:chs"..msg.sender.user_id) then
if text then
if text == "الغاء" then
Redis:del(FNKER.."set:chs"..msg.sender.user_id)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
if text:match("^@(.*)$") then
local ch = text:match("^@(.*)$")
Redis:set(FNKER.."chsource",ch)
Redis:del(FNKER.."set:chs"..msg.sender.user_id)
send(msg_chat_id,msg_id,'تم حفظ معرف Source FNKER ',"md",true)  
dofile('FNKER.lua')  
else
send(msg_chat_id,msg_id,'المعرف خطأ ',"md",true)  
end
...
Redis:set(FNKER.."set:chs"..msg.sender.user_id,true)
return send(msg_chat_id,msg_id,'ارسل معرف القناه الان',"md",true)  
end
if Redis:get(FNKER.."set:rmz"..msg.sender.user_id) then
if text then
if text == "الغاء" then
Redis:del(FNKER.."set:rmz"..msg.sender.user_id)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
Redis:set(FNKER..'rmzsource',text)
Redis:del(FNKER.."set:rmz"..msg.sender.user_id)
...
Redis:set(FNKER.."set:rmz"..msg.sender.user_id,true)
...
Redis:set(FNKER.."rmzsource","˖")
return send(msg_chat_id,msg_id,'تم ارجاع رمز السورس الي  { ˖ }',"md",true)  
end
if Redis:get(FNKER.."set:devs"..msg.sender.user_id) then
if text then
if text == "الغاء" then
Redis:del(FNKER.."set:devs"..msg.sender.user_id)
return send(msg_chat_id,msg_id,'تم الغاء الامر بنجاح ',"md",true)  
end
if text:match("^@(.*)$") then
local ch = text:match("^@(.*)$")
Redis:set(FNKER.."chdevolper",ch)
Redis:del(FNKER.."set:devs"..msg.sender.user_id)
...
Redis:set(FNKER.."set:devs"..msg.sender.user_id,true)
...
if not msg.Devss then
if Redis:get(FNKER.."TwaslBot") and not Redis:sismember(FNKER.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(FNKER.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(FNKER.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(FNKER..'BaN:In:Tuasl',Info_User)  
return send(msg_chat_id,msg_id,Reply_Status(Info_User,'˖ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(FNKER..'BaN:In:Tuasl',Info_User)  
...
Redis:srem(FNKER.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(FNKER..'*'..'-100'..data.supergroup.id..'*')
Redis:del(FNKER.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(FNKER.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(FNKER.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(FNKER.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(FNKER.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(FNKER.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(FNKER.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(FNKER.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(FNKER.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(FNKER.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(FNKER.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(FNKER.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(FNKER.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(FNKER.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(FNKER.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(FNKER.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(FNKER.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(FNKER.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(FNKER.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(FNKER.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(FNKER.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(FNKER) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(FNKER..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == FNKER then
...
data.The_Controller = 1
elseif Redis:sismember(FNKER.."Devss:Groups",Message_Edit.sender.user_id) == true then
data.The_Controller = 2
elseif Redis:sismember(FNKER.."Dev:Groups",Message_Edit.sender.user_id) == true then
data.The_Controller = 3
elseif Redis:sismember(FNKER.."Ownerss:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 44
elseif Redis:sismember(FNKER.."SuperCreator:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 4
elseif Redis:sismember(FNKER.."Creator:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 5
elseif Redis:sismember(FNKER.."Manger:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 6
elseif Redis:sismember(FNKER.."Admin:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 7
elseif Redis:sismember(FNKER.."Special:Group"..data.chat_id,Message_Edit.sender.user_id) == true then
data.The_Controller = 8
elseif tonumber(Message_Edit.sender.user_id) == tonumber(FNKER) then
...
Redis:incr(FNKER..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(FNKER.."Lock:edit"..data.chat_id) then
...
local get = Redis:get(FNKER..IdUser..ChatId.."num")
if get then
tf = get 
else
tf = "" 
...
local txx = tf..num
Redis:set(FNKER..IdUser..ChatId.."num",txx)
...
if tonumber(IdUser) == tonumber(sendrr) then
local math = Redis:get(FNKER..IdUser..ChatId.."num")
if math then
...
Redis:del(FNKER..IdUser..ChatId.."num")
else
LuaTele.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
Redis:set(FNKER..IdUser..ChatId.."num",gxx)
...
data.The_Controller = 1
elseif Redis:sismember(FNKER.."Devss:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(FNKER.."Dev:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(FNKER.."Ownerss:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(FNKER.."SuperCreator:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(FNKER.."Creator:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(FNKER.."Manger:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(FNKER.."Admin:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(FNKER.."Special:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(FNKER) then
data.The_Controller = 9
else
data.The_Controller = 10
end  
...
Redis:incrby(FNKER.."Num:Add:Games"..ChatId..IdUser, 1)  
...
if Text and Text:match('(.*)/yes_z/(.*)') then
  ...
  if tonumber(zwga_id) == tonumber(IdUser) then
    local zwga_name = LuaTele.getUser(zwga_id).first_name
    local zwg_name = LuaTele.getUser(zwg_id).first_name
    Redis:set(FNKER..ChatId..zwga_id.."mtzwga:", zwg_id)
    Redis:set(FNKER..ChatId..zwg_id.."mtzwga:", zwga_id)
...
if Text and Text:match('(%d+)/zeng') then
  ...
  if tonumber(UserId) == tonumber(IdUser) then
    Redis:set(FNKER..ChatId..IdUser.."zkrf:", "zeng")
...
if Text and Text:match('(.*)/a(.*)') then
    ...
    local z_text = Redis:get(FNKER..ChatId..IdUser.."zkrf:text")
    Redis:set(FNKER..ChatId..IdUser.."zkrf:num", z_num)
    if tonumber(UserId) == tonumber(IdUser) then
...
if Text and Text:match('(.*)/b(.*)') then
      ...
      local z_text = Redis:get(FNKER..ChatId..IdUser.."zkrf:text")
      local z_save = Redis:get(FNKER..ChatId..IdUser.."zkrf:num")
      if tonumber(UserId) == tonumber(IdUser) then
        local api = https.request("https://api-jack.ml/api19.php?text="..URL.escape(z_text))
        local zkrf = JSON.decode(api)
        ...
        Redis:del(FNKER..ChatId..IdUser.."zkrf:text")
        Redis:del(FNKER..ChatId..IdUser.."zkrf:num")
      end
      end
-- z  emo
...
if Text and Text:match('(%d+)/zar') then
    ...
    if tonumber(UserId) == tonumber(IdUser) then
      Redis:set(FNKER..ChatId..IdUser.."zkrf:", "zar")
      edit(ChatId, Msg_id, "▾ 𝙎𝙀𝙉𝘿 𝙐𝙍 𝙉𝘼𝙈𝙀 🎀..! \n \n✴ اࢪسل الاسم لتتم زخࢪفتھـۃ الان 🎀..!", "md",false)
    end
    end
...
Redis:del(FNKER.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(FNKER.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(FNKER.."Set:array"..IdUser..":"..ChatId)
Redis:del(FNKER.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(FNKER.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(FNKER.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(FNKER.."Set:On"..IdUser..":"..ChatId)
Redis:del(FNKER.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
Redis:del(FNKER.."Set:On:mz"..IdUser..":"..ChatId)
Redis:del(FNKER.."Set:Rd:mz"..IdUser..":"..ChatId)
...
if Text and Text:match('(%d+)/cancelkit') then
    ...
    Redis:del(FNKER.."Set:kit"..IdUser..":"..ChatId)
    edit(ChatId,Msg_id,"تم الغاء الامر بنجاح", 'md', true, false, reply_markup)
    end
    end
...
if Redis:get(FNKER..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(FNKER..'Set:array'..IdUser..':'..ChatId)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄʀ FNKER',url='https://t.me/QQQiiQ'}},
}
...
*]]
Redis:set(FNKER.."youtube"..IdUser..ChatId,'mp3')
...
*]]
Redis:set(FNKER.."youtube"..IdUser..ChatId,'mp4')
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(FNKER.."ChekBotAdd",UserId[2])
local U = LuaTele.getUser(IdUser)
Redis:set(FNKER.."Status:Id"..UserId[2],true) ;Redis:del(FNKER.."Status:Reply"..UserId[2]) ;Redis:del(FNKER.."Status:ReplySudo"..UserId[2]) ;Redis:set(FNKER.."Status:BanId"..UserId[2],true) ;Redis:set(FNKER.."Status:SetId"..UserId[2],true) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(FNKER.."Owners:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(FNKER.."Admin:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(FNKER.."SilentGroup:Group"..ChatId,replyy) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:srem(FNKER.."SilentGroup:Group"..ChatId,replyy) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(FNKER.."BanGroup:Group"..ChatId,replyy) 
...
print(replyy)
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:srem(FNKER.."BanGroup:Group"..ChatId,replyy) 
...
Redis:incrby(FNKER.."Num:Add:Games"..ChatId..IdUser,3)  
...
Redis:srem(FNKER.."Dev:Groups",info[2])
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:srem(FNKER.."Special:Group"..ChatId,IdUser)
Redis:srem(FNKER.."Admin:Group"..ChatId,IdUser)
Redis:srem(FNKER.."Manger:Group"..ChatId,IdUser)
Redis:srem(FNKER.."Creator:Group"..ChatId,IdUser)
Redis:srem(FNKER.."SuperCreator:Group"..ChatId,IdUser)
Redis:srem(FNKER.."Dev:Groups",IdUser) 
Redis:srem(FNKER.."Ownerss:Group"..ChatId,IdUser)
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(FNKER.."SuperCreator:Group"..ChatId,UserId[2]) then
Redis:srem(FNKER.."SuperCreator:Group"..ChatId,UserId[2])
else
Redis:sadd(FNKER.."SuperCreator:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(FNKER.."Creator:Group"..ChatId,UserId[2]) then
Redis:srem(FNKER.."Creator:Group"..ChatId,UserId[2])
else
Redis:sadd(FNKER.."Creator:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(FNKER.."Manger:Group"..ChatId,UserId[2]) then
Redis:srem(FNKER.."Manger:Group"..ChatId,UserId[2])
else
Redis:sadd(FNKER.."Manger:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(FNKER.."Admin:Group"..ChatId,UserId[2]) then
Redis:srem(FNKER.."Admin:Group"..ChatId,UserId[2])
else
Redis:sadd(FNKER.."Admin:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(FNKER.."Special:Group"..ChatId,UserId[2]) then
Redis:srem(FNKER.."Special:Group"..ChatId,UserId[2])
else
Redis:sadd(FNKER.."Special:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(FNKER.."Creator:Group"..ChatId,UserId[2])
Redis:srem(FNKER.."SuperCreator:Group"..ChatId,UserId[2])
Redis:srem(FNKER.."SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(FNKER.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(FNKER.."BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(FNKER.."BanGroup:Group"..ChatId,UserId[2])
LuaTele.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
Redis:sadd(FNKER.."BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(FNKER.."SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(FNKER.."SilentGroup:Group"..ChatId,UserId[2])
else
Redis:sadd(FNKER.."SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
*]]
Redis:set(FNKER.."toar"..IdUser,"on")
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
*]]
Redis:set(FNKER.."toen"..IdUser,"on")
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(FNKER.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(FNKER.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(FNKER.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(FNKER.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(FNKER.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(FNKER.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(FNKER..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(FNKER.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Supcreator:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."Special:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."twhd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."2rd:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."BanGroup:Group"..ChatId) 
edit(ChatId,Msg_id,"˖ تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FNKER.."SilentGroup:Group"..ChatId) 
